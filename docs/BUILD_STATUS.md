...
- Broker integration readiness report that combines schema audit, broker order
  ...
  through normalized handoff fields, scale-up and cutover both accept those
  direct final round-trip proof prefixes, and carry it as
...
Current passing suite: 794 tests.
