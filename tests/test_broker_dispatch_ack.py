...
def send_complete_final_target_application_lineage_comparison(
    vendor,
    *,
    lineage_sha256=None,
    **overrides,
...
def send_view_31_target_application_lineage_comparison(
    vendor,
    *,
    lineage_sha256=None,
    **overrides,
    ...
    comparison = send_complete_final_target_application_lineage_comparison(
        vendor,
...
def send_view_39_target_application_lineage_comparison(
    vendor,
    *,
    lineage_sha256=None,
    **overrides,
    ...
    comparison = send_view_31_target_application_lineage_comparison(
        vendor,
        lineage_sha256=lineage_sha256,
    )
    comparison.update(
...
def send_view_47_target_application_lineage_comparison(
    vendor,
    *,
    lineage_sha256=None,
    **overrides,
    ...
    comparison = send_view_39_target_application_lineage_comparison(
        vendor,
        lineage_sha256=lineage_sha256,
    )
    comparison.update(
...
def send_view_55_target_application_lineage_comparison(
    ...
    **overrides,
    ...
    comparison = send_view_47_target_application_lineage_comparison(
        vendor,
        lineage_sha256=lineage_sha256,
    )
...
def send_view_63_target_application_lineage_comparison(
    ...
    **overrides,
    ...
    comparison = send_view_55_target_application_lineage_comparison(
        vendor,
        lineage_sha256=lineage_sha256,
    )
    comparison.pop(
...
def send_view_71_target_application_lineage_comparison(
    ...
    **overrides,
    ...
    comparison = send_view_63_target_application_lineage_comparison(
        vendor,
        lineage_sha256=lineage_sha256,
    )
    comparison.update(
...
def send_view_79_target_application_lineage_comparison(
    ...
    **overrides,
    ...
    comparison = send_view_71_target_application_lineage_comparison(
        vendor,
        lineage_sha256=lineage_sha256,
    )
    comparison.update(
...
def ack_view_56_target_application_lineage_comparison(
    vendor,
    *,
    lineage_sha256=None,
    **overrides,
...
def ack_view_64_target_application_lineage_comparison(
    vendor,
    *,
    lineage_sha256=None,
    **overrides,
...
def ack_view_72_target_application_lineage_comparison(
    vendor,
    *,
    lineage_sha256=None,
    **overrides,
...
def add_send_complete_final_target_application_lineage(
    config,
    vendor,
    **overrides,
):
    ...
    ] = send_view_63_target_application_lineage_comparison(vendor)
    config[
    ...
    ] = send_view_71_target_application_lineage_comparison(vendor)
...
def with_dispatch_broker_vendor_batch_summary(summary, vendor):
    ...
    if vendor.get("mapping_source_mode") == "per_dataset_verified_target_application":
        ...
        complete_final_lineage = (
            send_complete_final_target_application_lineage_comparison(vendor)
        )
        extended_complete_final_lineage = (
            send_view_31_target_application_lineage_comparison(vendor)
        )
        extended_complete_final_lineage_39 = (
            send_view_39_target_application_lineage_comparison(vendor)
        )
        latest_extended_complete_final_lineage_47 = (
            send_view_47_target_application_lineage_comparison(vendor)
        )
        current_latest_extended_complete_final_lineage_55 = (
            send_view_55_target_application_lineage_comparison(vendor)
        )
        reconciled_current_latest_extended_complete_final_lineage_63 = (
            send_view_63_target_application_lineage_comparison(vendor)
        )
        verified_reconciled_current_latest_extended_complete_final_lineage_71 = (
            send_view_71_target_application_lineage_comparison(vendor)
        )
        ...
        for field, value in extended_complete_final_lineage.items():
            if field == "carried_application_lineage_sha256":
                result.loc[
                    0,
                    f"{extended_complete_final_prefix}_send_complete_final_review_carried_application_lineage_sha256",
                ] = value
            elif field not in {"required", "matches"}:
                result.loc[0, f"{extended_complete_final_prefix}_{field}"] = value
        result.loc[
            0,
            f"{extended_complete_final_39_prefix}_lineage_match_required",
        ] = extended_complete_final_lineage_39["required"]
        result.loc[
            0,
            f"{extended_complete_final_39_prefix}_lineage_matches",
        ] = extended_complete_final_lineage_39["matches"]
        for field, value in extended_complete_final_lineage_39.items():
            if field == "carried_application_lineage_sha256":
                result.loc[
                    0,
                    f"{extended_complete_final_39_prefix}_send_extended_complete_final_review_carried_application_lineage_sha256",
                ] = value
            elif field not in {"required", "matches"}:
                result.loc[0, f"{extended_complete_final_39_prefix}_{field}"] = value
        result.loc[
            0,
            f"{latest_extended_complete_final_47_prefix}_lineage_match_required",
        ] = latest_extended_complete_final_lineage_47["required"]
        result.loc[
            0,
            f"{latest_extended_complete_final_47_prefix}_lineage_matches",
        ] = latest_extended_complete_final_lineage_47["matches"]
        for field, value in latest_extended_complete_final_lineage_47.items():
            if field == "carried_application_lineage_sha256":
                result.loc[
                    0,
                    f"{latest_extended_complete_final_47_prefix}_send_latest_extended_complete_final_review_carried_application_lineage_sha256",
                ] = value
            elif field not in {"required", "matches"}:
                result.loc[
                    0,
                    f"{latest_extended_complete_final_47_prefix}_{field}",
                ] = value
        result.loc[
            0,
            f"{current_latest_extended_complete_final_55_prefix}_lineage_match_required",
        ] = current_latest_extended_complete_final_lineage_55["required"]
        result.loc[
            0,
            f"{current_latest_extended_complete_final_55_prefix}_lineage_matches",
        ] = current_latest_extended_complete_final_lineage_55["matches"]
        for field, value in current_latest_extended_complete_final_lineage_55.items():
            if field == "carried_application_lineage_sha256":
                result.loc[
                    0,
                    f"{current_latest_extended_complete_final_55_prefix}_send_current_latest_extended_complete_final_review_carried_application_lineage_sha256",
                ] = value
            elif field not in {"required", "matches"}:
                result.loc[
                    0,
                    f"{current_latest_extended_complete_final_55_prefix}_{field}",
                ] = value
        result.loc[
            0,
            f"{reconciled_current_latest_extended_complete_final_63_prefix}_lineage_match_required",
        ] = reconciled_current_latest_extended_complete_final_lineage_63["required"]
        result.loc[
            0,
            f"{reconciled_current_latest_extended_complete_final_63_prefix}_lineage_matches",
        ] = reconciled_current_latest_extended_complete_final_lineage_63["matches"]
        for field, value in (
            reconciled_current_latest_extended_complete_final_lineage_63.items()
        ):
            if field == "carried_application_lineage_sha256":
                result.loc[
                    0,
                    f"{reconciled_current_latest_extended_complete_final_63_prefix}_send_reconciled_current_latest_extended_complete_final_review_carried_application_lineage_sha256",
                ] = value
            elif field not in {"required", "matches"}:
                result.loc[
                    0,
                    f"{reconciled_current_latest_extended_complete_final_63_prefix}_{field}",
                ] = value
        result.loc[
            0,
            f"{verified_reconciled_current_latest_extended_complete_final_71_prefix}_lineage_match_required",
        ] = verified_reconciled_current_latest_extended_complete_final_lineage_71[
            "required"
        ]
        result.loc[
            0,
            f"{verified_reconciled_current_latest_extended_complete_final_71_prefix}_lineage_matches",
        ] = verified_reconciled_current_latest_extended_complete_final_lineage_71[
            "matches"
        ]
        for field, value in (
            verified_reconciled_current_latest_extended_complete_final_lineage_71.items()
        ):
            if field == "carried_application_lineage_sha256":
                result.loc[
                    0,
                    f"{verified_reconciled_current_latest_extended_complete_final_71_prefix}_send_verified_reconciled_current_latest_extended_complete_final_review_carried_application_lineage_sha256",
                ] = value
            elif field not in {"required", "matches"}:
                result.loc[
                    0,
                    f"{verified_reconciled_current_latest_extended_complete_final_71_prefix}_{field}",
                ] = value
    return result
...
def test_broker_dispatch_ack_carries_target_application_vendor_batch_from_dispatch_config():
    ...
    add_send_complete_final_target_application_lineage(config, vendor_input)
    ...
    for field in (
        ...
        assert summary[f"{send_complete_prefix}_{field}"] == lineage_sha256
    ack_complete_final = report.config[
        "ack_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch_lineage_comparison"
    ]
    assert ack_complete_final["required"]
    assert ack_complete_final["matches"]
    for field in (
        "current_application_lineage_sha256",
        "broker_application_lineage_sha256",
        "scaleup_carried_application_lineage_sha256",
        ...
        assert ack_complete_final[field] == lineage_sha256
    send_extended_prefix = (
        "send_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch"
    )
    extended_digest_fields = (
        "current_application_lineage_sha256",
        "broker_application_lineage_sha256",
        "scaleup_carried_application_lineage_sha256",
        "cutover_carried_application_lineage_sha256",
    ...
    assert summary[f"{send_extended_prefix}_lineage_match_required"]
    assert summary[f"{send_extended_prefix}_lineage_matches"]
    for field in (*extended_digest_fields, *extended_review_fields):
        assert summary[f"{send_extended_prefix}_{field}"] == lineage_sha256
    assert (
        summary[
            f"{send_extended_prefix}_ack_extended_complete_final_review_carried_application_lineage_sha256"
        ]
        == lineage_sha256
    )
    ack_extended_complete_final = report.config[
        "ack_extended_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch_lineage_comparison"
    ]
    assert ack_extended_complete_final["required"]
    assert ack_extended_complete_final["matches"]
    for field in (
        *extended_digest_fields,
        *extended_review_fields,
        "carried_application_lineage_sha256",
    ):
        assert ack_extended_complete_final[field] == lineage_sha256
    send_extended_39_prefix = (
        "send_extended_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch"
    )
    send_view_39 = send_view_39_target_application_lineage_comparison(vendor_input)
    for field, expected in send_view_39.items():
        ...
        assert summary[f"{send_extended_39_prefix}_{summary_field}"] == expected
    assert (
        summary[
            f"{send_extended_39_prefix}_ack_latest_extended_complete_final_review_carried_application_lineage_sha256"
        ]
        == lineage_sha256
    )
    ack_view_40 = report.config[
        "ack_latest_extended_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch_lineage_comparison"
    ]
    assert ack_view_40["required"]
    assert ack_view_40["matches"]
    for field, expected in send_view_39.items():
        if field in {
            "required",
            "matches",
            ...
            continue
        assert ack_view_40[field] == expected
    assert ack_view_40[
        "send_extended_complete_final_review_carried_application_lineage_sha256"
    ] == lineage_sha256
    assert ack_view_40["carried_application_lineage_sha256"] == lineage_sha256
    send_latest_prefix = (
        "send_latest_extended_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch"
    )
    send_view_47 = send_view_47_target_application_lineage_comparison(vendor_input)
    view_47_compatibility_only_fields = {
        "broker_readiness_extended_complete_final_review_carried_application_lineage_sha256",
        "scaleup_extended_complete_final_review_carried_application_lineage_sha256",
        "cutover_extended_complete_final_review_carried_application_lineage_sha256",
    }
    assert summary[f"{send_latest_prefix}_lineage_match_required"]
    assert summary[f"{send_latest_prefix}_lineage_matches"]
    for field, expected in send_view_47.items():
        if field in {
            "required",
            "matches",
            *view_47_compatibility_only_fields,
        ...
        assert summary[f"{send_latest_prefix}_{summary_field}"] == expected
    assert (
        summary[
            f"{send_latest_prefix}_ack_current_latest_extended_complete_final_review_carried_application_lineage_sha256"
        ]
        == lineage_sha256
    )
    ack_view_48 = report.config[
        "ack_current_latest_extended_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch_lineage_comparison"
    ]
    assert ack_view_48["required"]
    assert ack_view_48["matches"]
    for field, expected in send_view_47.items():
        if field in {
            "required",
            "matches",
            ...
            *view_47_compatibility_only_fields,
            ...
            continue
        assert ack_view_48[field] == expected
    assert (
        ack_view_48[
            "send_latest_extended_complete_final_review_carried_application_lineage_sha256"
        ]
    ...
    assert ack_view_48["carried_application_lineage_sha256"] == lineage_sha256
    send_current_prefix = (
        "send_current_latest_extended_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch"
    )
    send_view_55 = send_view_55_target_application_lineage_comparison(vendor_input)
    assert summary[f"{send_current_prefix}_lineage_match_required"]
    assert summary[f"{send_current_prefix}_lineage_matches"]
    for field, expected in send_view_55.items():
        if field in {"required", "matches", "carried_application_lineage_sha256"}:
            continue
        assert summary[f"{send_current_prefix}_{field}"] == expected
    assert (
        summary[
            f"{send_current_prefix}_ack_reconciled_current_latest_extended_complete_final_review_carried_application_lineage_sha256"
        ]
        == lineage_sha256
    )
    ack_view_56 = report.config[
    ...
    assert len(ack_view_56) == 55
    assert ack_view_56 == ack_view_56_target_application_lineage_comparison(
        vendor_input
    )
    send_reconciled_prefix = (
        "send_reconciled_current_latest_extended_complete_final_"
        "broker_dispatch_roundtrip_vendor_market_data_batch"
    )
    send_view_63 = send_view_63_target_application_lineage_comparison(vendor_input)
    assert len(send_view_63) == 62
    assert summary[f"{send_reconciled_prefix}_lineage_match_required"]
    assert summary[f"{send_reconciled_prefix}_lineage_matches"]
    for field, expected in send_view_63.items():
        if field in {"required", "matches", "carried_application_lineage_sha256"}:
            continue
        assert summary[f"{send_reconciled_prefix}_{field}"] == expected
    assert (
        summary[
            f"{send_reconciled_prefix}_ack_verified_reconciled_current_latest_extended_complete_final_review_carried_application_lineage_sha256"
        ]
        == lineage_sha256
    )
    ack_view_64 = report.config[
    ...
    assert len(ack_view_64) == 63
    assert ack_view_64 == ack_view_64_target_application_lineage_comparison(
        vendor_input
    )
    send_verified_prefix = (
        "send_verified_reconciled_current_latest_extended_complete_final_"
        "broker_dispatch_roundtrip_vendor_market_data_batch"
    )
    send_view_71 = send_view_71_target_application_lineage_comparison(vendor_input)
    assert len(send_view_71) == 70
    assert summary[f"{send_verified_prefix}_lineage_match_required"]
    assert summary[f"{send_verified_prefix}_lineage_matches"]
    for field, expected in send_view_71.items():
        if field in {"required", "matches", "carried_application_lineage_sha256"}:
            continue
        assert summary[f"{send_verified_prefix}_{field}"] == expected
    assert (
        summary[
            f"{send_verified_prefix}_ack_confirmed_verified_reconciled_current_latest_extended_complete_final_review_carried_application_lineage_sha256"
        ]
        == lineage_sha256
    )
    ack_view_72 = report.config[
    ...
    assert len(ack_view_72) == 71
    assert ack_view_72 == ack_view_72_target_application_lineage_comparison(
        vendor_input
    )
    complete_check_prefix = (
        "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_final"
    )
    expected_checks = {
        ...
        f"{complete_check_prefix}_compatibility_send_carried_lineage_sha256_matches",
    ...
    extended_check_prefix = (
        "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_complete_final"
    )
    expected_checks.update(
        {
            ...
            f"{extended_check_prefix}_compatibility_send_final_review_carried_lineage_sha256_matches",
        }
    )
    ...
    view_39_check_prefix = (
        "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_extended_complete_final"
    )
    expected_checks.update(
        {
            f"{view_39_check_prefix}_lineage_match_required",
            f"{view_39_check_prefix}_lineage_matches",
            f"{view_39_check_prefix}_source_lineage_sha256_matches",
            f"{view_39_check_prefix}_compatibility_broker_lineage_sha256_matches",
            f"{view_39_check_prefix}_compatibility_send_complete_final_review_carried_lineage_sha256_matches",
            f"{view_39_check_prefix}_broker_readiness_extended_complete_final_review_carried_lineage_sha256_matches",
            f"{view_39_check_prefix}_scaleup_extended_complete_final_review_carried_lineage_sha256_matches",
            f"{view_39_check_prefix}_cutover_extended_complete_final_review_carried_lineage_sha256_matches",
            f"{view_39_check_prefix}_route_extended_complete_final_review_carried_lineage_sha256_matches",
            f"{view_39_check_prefix}_dispatch_extended_complete_final_review_carried_lineage_sha256_matches",
            f"{view_39_check_prefix}_send_extended_complete_final_review_carried_lineage_sha256_matches",
            f"{view_39_check_prefix}_ack_latest_extended_complete_final_review_carried_lineage_sha256_matches",
        }
    )
    for stage in (
        "prior_scaleup",
        ...
        expected_checks.add(
            f"{view_39_check_prefix}_{stage}_carried_lineage_sha256_matches"
        )
    view_47_check_prefix = (
        "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_latest_extended_complete_final"
    )
    expected_checks.update(
        {
            f"{view_47_check_prefix}_lineage_match_required",
            f"{view_47_check_prefix}_lineage_matches",
            f"{view_47_check_prefix}_source_lineage_sha256_matches",
            f"{view_47_check_prefix}_compatibility_broker_lineage_sha256_matches",
            f"{view_47_check_prefix}_compatibility_send_extended_complete_final_review_carried_lineage_sha256_matches",
            f"{view_47_check_prefix}_broker_readiness_latest_extended_complete_final_review_carried_lineage_sha256_matches",
            f"{view_47_check_prefix}_scaleup_latest_extended_complete_final_review_carried_lineage_sha256_matches",
            f"{view_47_check_prefix}_cutover_latest_extended_complete_final_review_carried_lineage_sha256_matches",
            f"{view_47_check_prefix}_route_latest_extended_complete_final_review_carried_lineage_sha256_matches",
            f"{view_47_check_prefix}_dispatch_latest_extended_complete_final_review_carried_lineage_sha256_matches",
            f"{view_47_check_prefix}_send_latest_extended_complete_final_review_carried_lineage_sha256_matches",
            f"{view_47_check_prefix}_ack_current_latest_extended_complete_final_review_carried_lineage_sha256_matches",
        }
    )
    for stage in (
        "prior_scaleup",
        ...
        expected_checks.add(
            f"{view_47_check_prefix}_{stage}_carried_lineage_sha256_matches"
        )
    view_55_check_prefix = (
        "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_current_latest_extended_complete_final"
    )
    expected_checks.update(
        {
            f"{view_55_check_prefix}_lineage_match_required",
            f"{view_55_check_prefix}_lineage_matches",
            f"{view_55_check_prefix}_source_lineage_sha256_matches",
            f"{view_55_check_prefix}_compatibility_broker_lineage_sha256_matches",
            f"{view_55_check_prefix}_compatibility_ack_current_latest_extended_complete_final_review_carried_lineage_sha256_matches",
        }
    )
    expected_checks.update(
        f"{view_55_check_prefix}_{stage}_carried_lineage_sha256_matches"
        for stage in (
    ...
    view_63_check_prefix = (
        "send_broker_dispatch_roundtrip_vendor_market_data_batch_"
        "send_reconciled_current_latest_extended_complete_final"
    )
    expected_checks.update(
        {
            f"{view_63_check_prefix}_lineage_match_required",
            f"{view_63_check_prefix}_lineage_matches",
            f"{view_63_check_prefix}_source_lineage_sha256_matches",
            f"{view_63_check_prefix}_compatibility_broker_lineage_sha256_matches",
            f"{view_63_check_prefix}_compatibility_ack_reconciled_current_latest_extended_complete_final_review_carried_lineage_sha256_matches",
            f"{view_63_check_prefix}_send_reconciled_current_latest_extended_complete_final_review_generic_carried_lineage_sha256_matches",
            f"{view_63_check_prefix}_ack_verified_reconciled_current_latest_extended_complete_final_review_carried_lineage_sha256_matches",
        }
    )
    for field in send_view_63:
        if not field.endswith("_carried_application_lineage_sha256") or field == (
            "carried_application_lineage_sha256"
        ):
            continue
        ...
        if stage == "scaleup":
            ...
            stage = "prior_cutover"
        expected_checks.add(
            f"{view_63_check_prefix}_{stage}_carried_lineage_sha256_matches"
        )
    view_71_check_prefix = (
        "send_broker_dispatch_roundtrip_vendor_market_data_batch_"
        "send_verified_reconciled_current_latest_extended_complete_final"
    )
    expected_checks.update(
        {
            f"{view_71_check_prefix}_lineage_match_required",
            f"{view_71_check_prefix}_lineage_matches",
            f"{view_71_check_prefix}_source_lineage_sha256_matches",
            f"{view_71_check_prefix}_compatibility_broker_lineage_sha256_matches",
            f"{view_71_check_prefix}_compatibility_ack_verified_reconciled_current_latest_extended_complete_final_review_carried_lineage_sha256_matches",
            f"{view_71_check_prefix}_send_verified_reconciled_current_latest_extended_complete_final_review_generic_carried_lineage_sha256_matches",
            f"{view_71_check_prefix}_ack_confirmed_verified_reconciled_current_latest_extended_complete_final_review_carried_lineage_sha256_matches",
        }
    )
    for field in send_view_71:
        if not field.endswith("_carried_application_lineage_sha256") or field == (
            "carried_application_lineage_sha256"
        ):
            continue
        ...
        if stage == "scaleup":
            ...
            stage = "prior_cutover"
        expected_checks.add(
            f"{view_71_check_prefix}_{stage}_carried_lineage_sha256_matches"
        )
...
def test_broker_dispatch_ack_carries_target_application_vendor_batch_from_dispatch_summary():
    ...
    assert extended_lineage["carried_application_lineage_sha256"] == lineage_sha256
    ack_view_56 = report.config[
        "ack_reconciled_current_latest_extended_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch_lineage_comparison"
    ]
    assert len(ack_view_56) == 55
    assert ack_view_56 == ack_view_56_target_application_lineage_comparison(vendor)
    ack_view_64 = report.config[
        "ack_verified_reconciled_current_latest_extended_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch_lineage_comparison"
    ]
    assert len(ack_view_64) == 63
    assert ack_view_64 == ack_view_64_target_application_lineage_comparison(vendor)
    ack_view_72 = report.config[
        "ack_confirmed_verified_reconciled_current_latest_extended_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch_lineage_comparison"
    ]
    assert len(ack_view_72) == 71
    assert ack_view_72 == ack_view_72_target_application_lineage_comparison(vendor)
...
def test_broker_dispatch_ack_blocks_send_complete_final_lineage_drift():
    vendor = target_application_vendor_market_data_batch_config()
    lineage_sha256 = target_application_lineage_sha256(vendor["datasets"])
    config = dispatch_config()
    input_prefix = "dispatch_broker_dispatch_roundtrip_vendor_market_data_batch"
    ...
    add_send_complete_final_target_application_lineage(
        config,
        vendor,
...
def test_broker_dispatch_ack_blocks_send_view_31_drift_while_preserving_view_23():
    vendor = target_application_vendor_market_data_batch_config()
    lineage_sha256 = target_application_lineage_sha256(vendor["datasets"])
    config = dispatch_config()
    input_prefix = "dispatch_broker_dispatch_roundtrip_vendor_market_data_batch"
    ...
    add_send_complete_final_target_application_lineage(config, vendor)
    config[
        "send_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch_lineage_comparison"
    ] = send_view_31_target_application_lineage_comparison(
        vendor,
        lineage_sha256="f" * 64,
    )
    ...
    assert final_lineage["broker_application_lineage_sha256"] == lineage_sha256
    assert final_lineage["carried_application_lineage_sha256"] == lineage_sha256
    assert complete_final_lineage["broker_application_lineage_sha256"] == (
        lineage_sha256
    )
    assert complete_final_lineage[
        "send_final_review_carried_application_lineage_sha256"
    ] == lineage_sha256
    assert complete_final_lineage["carried_application_lineage_sha256"] == (
        lineage_sha256
    )
    extended_final_lineage = report.config[
        "ack_extended_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch_lineage_comparison"
    ]
    assert extended_final_lineage["broker_application_lineage_sha256"] == "f" * 64
    assert (
        extended_final_lineage[
            "send_complete_final_review_carried_application_lineage_sha256"
        ]
        == "f" * 64
    )
    assert (
        extended_final_lineage["carried_application_lineage_sha256"]
        == lineage_sha256
    )


def test_broker_dispatch_ack_blocks_send_view_39_drift_while_preserving_view_32():
    vendor = target_application_vendor_market_data_batch_config()
    lineage_sha256 = target_application_lineage_sha256(vendor["datasets"])
    config = dispatch_config()
    input_prefix = "dispatch_broker_dispatch_roundtrip_vendor_market_data_batch"
    ...
    config[
        "send_extended_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch_lineage_comparison"
    ] = send_view_39_target_application_lineage_comparison(
        vendor,
        lineage_sha256="f" * 64,
    )
    ...
    ack_view_32 = report.config[
        "ack_extended_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch_lineage_comparison"
    ]
    assert ack_view_32["broker_application_lineage_sha256"] == lineage_sha256
    assert (
        ack_view_32[
            "send_complete_final_review_carried_application_lineage_sha256"
        ]
    ...
    assert ack_view_32["carried_application_lineage_sha256"] == lineage_sha256
    assert ack_view_32["broker_application_lineage_sha256"] != "f" * 64
    ack_view_40 = report.config[
        "ack_latest_extended_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch_lineage_comparison"
    ]
    assert ack_view_40["broker_application_lineage_sha256"] == "f" * 64
    assert (
        ack_view_40[
            "send_extended_complete_final_review_carried_application_lineage_sha256"
        ]
...
def test_broker_dispatch_ack_blocks_send_view_47_drift_while_preserving_view_40():
    vendor = target_application_vendor_market_data_batch_config()
    lineage_sha256 = target_application_lineage_sha256(vendor["datasets"])
    config = dispatch_config()
    input_prefix = "dispatch_broker_dispatch_roundtrip_vendor_market_data_batch"
    ...
    config[
        "send_latest_extended_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch_lineage_comparison"
    ] = send_view_47_target_application_lineage_comparison(
        vendor,
        lineage_sha256="f" * 64,
    )
    ...
    assert ack_view_40["broker_application_lineage_sha256"] == lineage_sha256
    assert (
        ack_view_40[
            "send_extended_complete_final_review_carried_application_lineage_sha256"
        ]
    ...
    assert ack_view_48["broker_application_lineage_sha256"] == "f" * 64
    assert (
        ack_view_48[
            "send_latest_extended_complete_final_review_carried_application_lineage_sha256"
        ]
...
def test_broker_dispatch_ack_blocks_send_view_55_drift_while_preserving_view_48():
    vendor = target_application_vendor_market_data_batch_config()
    lineage_sha256 = target_application_lineage_sha256(vendor["datasets"])
    config = dispatch_config()
    input_prefix = "dispatch_broker_dispatch_roundtrip_vendor_market_data_batch"
    ...
    config[
        "send_current_latest_extended_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch_lineage_comparison"
    ] = send_view_55_target_application_lineage_comparison(
        vendor,
        lineage_sha256="f" * 64,
    )
    ...
    assert {
        ...
        f"{check_prefix}_ack_reconciled_current_latest_extended_complete_final_review_carried_lineage_sha256_matches",
    } <= failed
    ack_view_48 = report.config[
        "ack_current_latest_extended_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch_lineage_comparison"
    ]
    assert ack_view_48["required"]
    assert ack_view_48["matches"]
    assert ack_view_48["broker_application_lineage_sha256"] == lineage_sha256
    assert (
        ack_view_48[
            "send_latest_extended_complete_final_review_carried_application_lineage_sha256"
        ]
    ...
    assert ack_view_56["broker_application_lineage_sha256"] == "f" * 64
    assert (
        ack_view_56[
    ...
    assert ack_view_56["carried_application_lineage_sha256"] == lineage_sha256


def test_broker_dispatch_ack_blocks_send_view_63_drift_while_preserving_view_56():
    vendor = target_application_vendor_market_data_batch_config()
    lineage_sha256 = target_application_lineage_sha256(vendor["datasets"])
    ...
    config[
        "send_reconciled_current_latest_extended_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch_lineage_comparison"
    ] = send_view_63_target_application_lineage_comparison(
        vendor,
    ...
    drifted_view_63 = send_view_63_target_application_lineage_comparison(
        vendor,
        lineage_sha256=drifted_lineage_sha256,
    )
    for field, value in drifted_view_63.items():
        if field == "required":
            ...
            summary.loc[
                0,
                f"{summary_prefix}_send_reconciled_current_latest_extended_complete_final_review_carried_application_lineage_sha256",
            ] = value
        else:
    ...
    assert ack_view_56 == ack_view_56_target_application_lineage_comparison(vendor)
    assert ack_view_56["broker_application_lineage_sha256"] == lineage_sha256
    assert ack_view_56["broker_application_lineage_sha256"] != drifted_lineage_sha256
    ack_view_64 = report.config[
        "ack_verified_reconciled_current_latest_extended_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch_lineage_comparison"
    ]
    assert ack_view_64["broker_application_lineage_sha256"] == drifted_lineage_sha256
    assert (
        ack_view_64[
    ...
    assert ack_view_64["carried_application_lineage_sha256"] == lineage_sha256


def test_broker_dispatch_ack_blocks_send_view_71_drift_while_preserving_view_64():
    vendor = target_application_vendor_market_data_batch_config()
    lineage_sha256 = target_application_lineage_sha256(vendor["datasets"])
    drifted_lineage_sha256 = "f" * 64
    config = dispatch_config()
    ...
    add_send_complete_final_target_application_lineage(config, vendor)
    drifted_view_71 = send_view_71_target_application_lineage_comparison(
        vendor,
        lineage_sha256=drifted_lineage_sha256,
    )
    assert len(drifted_view_71) == 70
    config[
        "send_verified_reconciled_current_latest_extended_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch_lineage_comparison"
    ] = drifted_view_71
    summary = with_dispatch_broker_vendor_batch_summary(dispatch_summary(), vendor)
    ...
    summary.loc[0, f"{view_71_prefix}_lineage_match_required"] = (
        drifted_view_71["required"]
    )
    summary.loc[0, f"{view_71_prefix}_lineage_matches"] = drifted_view_71[
        "matches"
    ]
    for field, value in drifted_view_71.items():
        if field in {"required", "matches", "carried_application_lineage_sha256"}:
            continue
        summary.loc[0, f"{view_71_prefix}_{field}"] = value
    ...
    assert ack_view_64["broker_application_lineage_sha256"] == lineage_sha256
    assert ack_view_64["broker_application_lineage_sha256"] != (
        drifted_lineage_sha256
    )
    ack_view_72 = report.config[
        "ack_confirmed_verified_reconciled_current_latest_extended_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch_lineage_comparison"
    ]
    assert ack_view_72["broker_application_lineage_sha256"] == drifted_lineage_sha256
    assert (
        ack_view_72[
    ...
    assert ack_view_72["carried_application_lineage_sha256"] == lineage_sha256


def test_broker_dispatch_ack_ignores_additive_send_view_79():
    vendor = target_application_vendor_market_data_batch_config()
    lineage_sha256 = target_application_lineage_sha256(vendor["datasets"])
    drifted_lineage_sha256 = "f" * 64
    config = dispatch_config()
    ...
    add_send_complete_final_target_application_lineage(config, vendor)
    additive_view_79 = send_view_79_target_application_lineage_comparison(
        vendor,
        lineage_sha256=drifted_lineage_sha256,
    )
    assert len(additive_view_79) == 78
    config[
    ...
    summary.loc[0, f"{additive_prefix}_lineage_match_required"] = additive_view_79[
        "required"
    ]
    summary.loc[0, f"{additive_prefix}_lineage_matches"] = additive_view_79[
        "matches"
    ]
    for field, value in additive_view_79.items():
        if field in {"required", "matches", "carried_application_lineage_sha256"}:
            continue
    ...
    assert ack_view_72 == ack_view_72_target_application_lineage_comparison(vendor)
    assert ack_view_72["broker_application_lineage_sha256"] == lineage_sha256
    assert ack_view_72["broker_application_lineage_sha256"] != drifted_lineage_sha256
    checks = set(report.checks["check"])
    assert not any(
        "send_confirmed_verified_reconciled_current_latest_extended_complete_final"
        in check
        for check in checks
    )


def test_broker_dispatch_ack_requires_send_view_71_lineage_for_confirmed_verified_target():
    vendor = target_application_vendor_market_data_batch_config()
    config = dispatch_config()
    input_prefix = "dispatch_broker_dispatch_roundtrip_vendor_market_data_batch"
    config[input_prefix] = vendor
    ...
    assert not ack_view_72["required"]
    assert not ack_view_72["matches"]


@pytest.mark.parametrize(
    ("field", "value", "expected_failed_check_suffix"),
    [
        ...
        (
            "carried_application_lineage_sha256",
            "f" * 64,
            "send_verified_reconciled_current_latest_extended_complete_final_review_generic_carried_lineage_sha256_matches",
        ),
    ],
)
def test_broker_dispatch_ack_blocks_invalid_send_view_71_lineage(
    field,
    value,
    expected_failed_check_suffix,
):
    vendor = target_application_vendor_market_data_batch_config()
    config = dispatch_config()
    input_prefix = "dispatch_broker_dispatch_roundtrip_vendor_market_data_batch"
    ...
    assert (
        "send_broker_dispatch_roundtrip_vendor_market_data_batch_"
        "send_verified_reconciled_current_latest_extended_complete_final_"
        f"{expected_failed_check_suffix}"
    ) in failed


def test_broker_dispatch_ack_requires_send_view_63_lineage_for_verified_target():
    vendor = target_application_vendor_market_data_batch_config()
    config = dispatch_config()
    input_prefix = "dispatch_broker_dispatch_roundtrip_vendor_market_data_batch"
    config[input_prefix] = vendor
    ...
    assert not ack_view_64["required"]
    assert not ack_view_64["matches"]
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "carried_application_lineage_sha256",
            "f" * 64,
            "send_reconciled_current_latest_extended_complete_final_review_generic_carried_lineage_sha256_matches",
        ),
    ],
)
def test_broker_dispatch_ack_blocks_invalid_send_view_63_lineage(
    field,
    value,
    expected_failed_check_suffix,
):
...
def test_broker_dispatch_ack_requires_send_view_55_lineage():
    vendor = target_application_vendor_market_data_batch_config()
    config = dispatch_config()
    input_prefix = "dispatch_broker_dispatch_roundtrip_vendor_market_data_batch"
    config[input_prefix] = vendor
    ...
    assert not ack_view_56["required"]
    assert not ack_view_56["matches"]
...
@pytest.mark.parametrize(
    ...
    [
        (
            "required",
            False,
            "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_current_latest_extended_complete_final_lineage_match_required",
        ),
        (
            "matches",
            False,
            "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_current_latest_extended_complete_final_lineage_matches",
        ),
        (
            "current_application_lineage_sha256",
            "f" * 64,
            "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_current_latest_extended_complete_final_source_lineage_sha256_matches",
        ),
        (
            "roundtrip_current_latest_extended_complete_final_review_carried_application_lineage_sha256",
            "f" * 64,
            "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_current_latest_extended_complete_final_roundtrip_current_latest_extended_complete_final_review_carried_lineage_sha256_matches",
        ),
        (
            "carried_application_lineage_sha256",
            "f" * 64,
            "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_current_latest_extended_complete_final_send_current_latest_extended_complete_final_review_generic_carried_lineage_sha256_matches",
        ),
    ],
)
def test_broker_dispatch_ack_blocks_invalid_send_view_55_lineage(
    field,
    value,
...
def test_broker_dispatch_ack_requires_send_view_47_lineage():
    vendor = target_application_vendor_market_data_batch_config()
    config = dispatch_config()
    input_prefix = "dispatch_broker_dispatch_roundtrip_vendor_market_data_batch"
    config[input_prefix] = vendor
    ...
    assert not ack_view_48["required"]
    assert not ack_view_48["matches"]
...
@pytest.mark.parametrize(
    ...
    [
        (
            "required",
            False,
            "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_latest_extended_complete_final_lineage_match_required",
        ),
        (
            "matches",
            False,
            "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_latest_extended_complete_final_lineage_matches",
        ),
        (
            "current_application_lineage_sha256",
            "f" * 64,
            "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_latest_extended_complete_final_source_lineage_sha256_matches",
        ),
        (
            "send_extended_complete_final_review_carried_application_lineage_sha256",
            "f" * 64,
            "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_latest_extended_complete_final_send_extended_complete_final_review_carried_lineage_sha256_matches",
        ),
        (
            "carried_application_lineage_sha256",
            "f" * 64,
            "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_latest_extended_complete_final_send_latest_extended_complete_final_review_carried_lineage_sha256_matches",
        ),
    ],
)
def test_broker_dispatch_ack_blocks_invalid_send_view_47_lineage(
    field,
    value,
    expected_failed_check,
):
...
def test_broker_dispatch_ack_requires_send_view_39_lineage():
    vendor = target_application_vendor_market_data_batch_config()
    config = dispatch_config()
    input_prefix = "dispatch_broker_dispatch_roundtrip_vendor_market_data_batch"
    config[input_prefix] = vendor
    ...
    assert not ack_view_40["required"]
    assert not ack_view_40["matches"]
...
@pytest.mark.parametrize(
    ...
    [
        (
            "required",
            False,
            "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_extended_complete_final_lineage_match_required",
        ),
        (
            "matches",
            False,
            "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_extended_complete_final_lineage_matches",
        ),
        (
            "current_application_lineage_sha256",
            "f" * 64,
            "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_extended_complete_final_source_lineage_sha256_matches",
        ),
        (
            "send_complete_final_review_carried_application_lineage_sha256",
            "f" * 64,
            "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_extended_complete_final_send_complete_final_review_carried_lineage_sha256_matches",
        ),
        (
            "carried_application_lineage_sha256",
            "f" * 64,
            "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_extended_complete_final_send_extended_complete_final_review_carried_lineage_sha256_matches",
        ),
    ],
)
def test_broker_dispatch_ack_blocks_invalid_send_view_39_lineage(
    field,
    value,
    expected_failed_check,
):
...
def test_broker_dispatch_ack_requires_send_view_31_lineage():
    vendor = target_application_vendor_market_data_batch_config()
    config = dispatch_config()
    input_prefix = "dispatch_broker_dispatch_roundtrip_vendor_market_data_batch"
    config[input_prefix] = vendor
...
def test_broker_dispatch_ack_requires_send_complete_final_lineage_for_reconciled_target():
    config = dispatch_config()
    vendor = target_application_vendor_market_data_batch_config()
    input_prefix = "dispatch_broker_dispatch_roundtrip_vendor_market_data_batch"
    config[input_prefix] = vendor
    ...
    assert not report.passed
    check_prefix = "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_final"
    failed = set(report.checks.loc[~report.checks["passed"].astype(bool), "check"])
    assert {
        f"{check_prefix}_lineage_match_required",
        f"{check_prefix}_lineage_matches",
...
@pytest.mark.parametrize(
    ...
    [
        (
            "required",
            False,
            "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_final_lineage_match_required",
        ),
        (
            "matches",
            False,
            "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_final_lineage_matches",
        ),
        (
            "current_application_lineage_sha256",
            "f" * 64,
            "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_final_source_lineage_sha256_matches",
        ),
        (
            "cutover_final_review_carried_application_lineage_sha256",
            "f" * 64,
            "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_final_cutover_final_review_carried_lineage_sha256_matches",
        ),
        (
            "carried_application_lineage_sha256",
            "f" * 64,
            "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_final_send_final_review_carried_lineage_sha256_matches",
        ),
    ],
)
def test_broker_dispatch_ack_blocks_invalid_send_complete_final_lineage_comparison(
    field,
    value,
    expected_failed_check,
):
...
@pytest.mark.parametrize(
    ...
    [
        (
            "required",
            False,
            "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_complete_final_lineage_match_required",
        ),
        (
            "matches",
            False,
            "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_complete_final_lineage_matches",
        ),
        (
            "current_application_lineage_sha256",
            "f" * 64,
            "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_complete_final_source_lineage_sha256_matches",
        ),
        (
            "dispatch_complete_final_review_carried_application_lineage_sha256",
            "f" * 64,
            "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_complete_final_dispatch_complete_final_review_carried_lineage_sha256_matches",
        ),
        (
            "carried_application_lineage_sha256",
            "f" * 64,
            "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_complete_final_send_complete_final_review_carried_lineage_sha256_matches",
        ),
    ],
)
def test_broker_dispatch_ack_blocks_invalid_send_view_31_lineage_comparison(
    field,
    value,
    expected_failed_check,
):
...
def test_broker_dispatch_ack_does_not_require_final_comparison_when_consistency_is_absent():
    ...
    extended_prefix = (
        "send_broker_dispatch_roundtrip_vendor_market_data_batch_send_complete_final_"
    )
...
def test_broker_dispatch_ack_consumes_sender_target_lineage_handoff():
    ...
    add_send_complete_final_target_application_lineage(send_config, vendor)
    report = evaluate_broker_dispatch_acknowledgements(
        dispatch_summary=dispatch_summary(),
        dispatch_orders=dispatch_orders(),
        broker_acks=ack_rows(),
