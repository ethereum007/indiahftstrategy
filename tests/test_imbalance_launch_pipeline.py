...
def test_cli_pipeline_imbalance_launch_forwards_broker_vendor_data_proof_root(tmp_path):
    ...
    assert_broker_vendor_data_proof_forwarded(out_dir, summary_file="imbalance_launch_pipeline_summary.csv")


def test_cli_pipeline_imbalance_launch_blocks_mismatched_broker_vendor_data_proof_root(tmp_path):
    promotion_dir = tmp_path / "promotion"
...
def test_cli_pipeline_imbalance_launch_blocks_wrong_kind_broker_vendor_data_proof_root(tmp_path):
    promotion_dir = tmp_path / "promotion"
...
def test_cli_pipeline_imbalance_launch_blocks_wrong_manifest_broker_vendor_data_proof_root(tmp_path):
    promotion_dir = tmp_path / "promotion"
