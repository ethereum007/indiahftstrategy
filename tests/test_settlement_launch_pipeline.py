...
def test_cli_pipeline_settlement_launch_forwards_broker_vendor_data_proof_root(tmp_path):
    promotion_dir = tmp_path / "promotion"
    proof_dir = write_broker_vendor_data_proof(tmp_path / "broker_vendor_data")
    out_dir = tmp_path / "pipeline"
    write_promotion(promotion_dir)
...
def test_cli_pipeline_settlement_launch_blocks_wrong_market_broker_vendor_data_proof_root(tmp_path):
    promotion_dir = tmp_path / "promotion"
...
def test_cli_pipeline_settlement_launch_blocks_wrong_manifest_broker_vendor_data_proof_root(tmp_path):
    promotion_dir = tmp_path / "promotion"
