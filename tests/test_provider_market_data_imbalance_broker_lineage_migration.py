...
def _write_provider_chain(root: Path, *, strict: bool) -> dict[str, Path]:
    ...
    roundtrip = root / "02_provider_roundtrip"
    roundtrip.mkdir()
    ...
    certificate = root / "03_rehearsal_certificate"
    certificate.mkdir()
