...
from execution.universe import LiquidityFilters, LiquidityObservation, liquid_universe
...
def test_nse_liquidity_universe_fails_illiquid_names():
    ...
    liquid = LiquidityObservation(
        "LIQUID", Decimal("2000000"), Decimal("2"), 500, Decimal("20"), Decimal("100"), 10, 50000
    )
