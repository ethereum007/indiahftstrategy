...
def _candidate_row(row: pd.Series, candidate_config: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "instrument_id": _jsonable(replay_defaults.get("instrument_id")),
        "instrument_kind": _jsonable(replay_defaults.get("instrument_kind")),
        "lot_size": _jsonable(replay_defaults.get("lot_size")),
        "qty": _jsonable(replay_defaults.get("qty")),
        "entry_imbalance": _jsonable(replay_defaults.get("entry_imbalance")),
        "exit_imbalance": _jsonable(replay_defaults.get("exit_imbalance")),
        "min_microprice_edge_ticks": _jsonable(replay_defaults.get("min_microprice_edge_ticks")),
        "max_spread_ticks": _jsonable(replay_defaults.get("max_spread_ticks")),
        "min_depth": _jsonable(replay_defaults.get("min_depth")),
...
def _promotion_candidate_config(
    ...
    return {
        ...
        "parameters": {
            "instrument_id": _jsonable(candidate.get("instrument_id")),
            "instrument_kind": _jsonable(candidate.get("instrument_kind")),
            "lot_size": _jsonable(candidate.get("lot_size")),
            "qty": _jsonable(candidate.get("qty")),
            "entry_imbalance": _jsonable(candidate.get("entry_imbalance")),
            "exit_imbalance": _jsonable(candidate.get("exit_imbalance")),
            "min_microprice_edge_ticks": _jsonable(candidate.get("min_microprice_edge_ticks")),
            "max_spread_ticks": _jsonable(candidate.get("max_spread_ticks")),
            "min_depth": _jsonable(candidate.get("min_depth")),
