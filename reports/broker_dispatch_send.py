...
CONTRACT_IDENTITY_REQUEST_COLUMNS = tuple(
    request_column for _dispatch_column, request_column in CONTRACT_IDENTITY_COLUMNS
)
CONTRACT_IDENTITY_INTEGER_COLUMNS = {
    "contract_identity_row_number",
    "leg_index",
    "leg_count",
}
CONTRACT_IDENTITY_BOOLEAN_COLUMNS = {
    "upload_identity_matches",
    "resolution_row_ready",
}
INTERNAL_IDENTITY_ORDER_FIELDS = {
...
DISPATCH_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_54_FIELD_PREFIX = (
    "dispatch_current_latest_extended_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch"
)
DISPATCH_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_54_SUMMARY_FIELD_PREFIX = (
    "route_current_latest_extended_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch"
)
DISPATCH_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_54_DIGEST_FIELDS: tuple[
    str, ...
] = DISPATCH_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_46_DIGEST_FIELDS
DISPATCH_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_54_STAGE_FIELDS: tuple[
    str, ...
] = (
...
DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_FIELD_PREFIX = (
    "dispatch_reconciled_current_latest_extended_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch"
)
DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_SUMMARY_FIELD_PREFIX = (
    "route_reconciled_current_latest_extended_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch"
)
DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_DIGEST_FIELDS: tuple[
    str, ...
] = DISPATCH_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_54_DIGEST_FIELDS
DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_STAGE_FIELDS: tuple[
    str, ...
] = DISPATCH_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_54_STAGE_FIELDS
DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_CURRENT_STAGE_FIELDS: tuple[
    str, ...
] = (
...
DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_BROKER_READINESS_REVIEW_FIELD = (
    "broker_readiness_reconciled_current_latest_extended_complete_final_review_carried_application_lineage_sha256"
)
DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_SCALEUP_REVIEW_FIELD = (
    "scaleup_reconciled_current_latest_extended_complete_final_review_carried_application_lineage_sha256"
)
DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_CUTOVER_REVIEW_FIELD = (
    "cutover_reconciled_current_latest_extended_complete_final_review_carried_application_lineage_sha256"
)
DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_ROUTE_REVIEW_FIELD = (
    "route_reconciled_current_latest_extended_complete_final_review_carried_application_lineage_sha256"
)
DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_DISPATCH_REVIEW_FIELD = (
...
DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_FIELD_PREFIX = (
    "dispatch_verified_reconciled_current_latest_extended_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch"
)
DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_SUMMARY_FIELD_PREFIX = (
    "route_verified_reconciled_current_latest_extended_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch"
)
DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_DIGEST_FIELDS: tuple[
    str, ...
] = DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_DIGEST_FIELDS
DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_STAGE_FIELDS: tuple[
    str, ...
] = DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_STAGE_FIELDS
DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_CURRENT_STAGE_FIELDS: tuple[
    str, ...
] = DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_CURRENT_STAGE_FIELDS
DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_REVIEW_FIELDS: tuple[
    str, ...
] = (
    "broker_readiness_reconciled_current_latest_extended_complete_final_review_carried_application_lineage_sha256",
    "scaleup_reconciled_current_latest_extended_complete_final_review_carried_application_lineage_sha256",
...
DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_ACK_REVIEW_FIELD = (
    "ack_verified_reconciled_current_latest_extended_complete_final_review_carried_application_lineage_sha256"
)
DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_ROUNDTRIP_REVIEW_FIELD = (
    "roundtrip_verified_reconciled_current_latest_extended_complete_final_review_carried_application_lineage_sha256"
)
DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_BROKER_READINESS_REVIEW_FIELD = (
    "broker_readiness_verified_reconciled_current_latest_extended_complete_final_review_carried_application_lineage_sha256"
)
DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_SCALEUP_REVIEW_FIELD = (
    "scaleup_verified_reconciled_current_latest_extended_complete_final_review_carried_application_lineage_sha256"
)
DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_CUTOVER_REVIEW_FIELD = (
    "cutover_verified_reconciled_current_latest_extended_complete_final_review_carried_application_lineage_sha256"
)
DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_ROUTE_REVIEW_FIELD = (
    "route_verified_reconciled_current_latest_extended_complete_final_review_carried_application_lineage_sha256"
)
DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_DISPATCH_REVIEW_FIELD = (
...
DISPATCH_CONFIRMED_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_78_FIELD_PREFIX = (
    "dispatch_confirmed_verified_reconciled_current_latest_extended_complete_final_broker_dispatch_roundtrip_vendor_market_data_batch"
)
DISPATCH_CONFIRMED_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_78_SUMMARY_FIELD_PREFIX = (
...
DISPATCH_CONFIRMED_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_78_REVIEW_FIELDS: tuple[
    str, ...
] = (
...
DISPATCH_CONFIRMED_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_78_DISPATCH_REVIEW_FIELD = (
    "dispatch_confirmed_verified_reconciled_current_latest_extended_complete_final_review_carried_application_lineage_sha256"
)
SEND_CONFIRMED_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_79_COMPARISON_KEY = (
...
def evaluate_broker_dispatch_send_packet(
    *,
    ...
    identity_state = _contract_identity_state(
        summary_row,
        dispatch_orders,
        upload_contract_identity,
        upload_contract_identity_evidence,
    )
    for column, value in _contract_identity_state_fields(identity_state).items():
        summary_row[column] = value
    requests = _request_rows(summary_row, dispatch_orders, identity_state)
    expected_acks = _expected_ack_template(requests)
    identity_state = _complete_contract_identity_state(
        identity_state,
        dispatch_orders,
        requests,
        expected_acks,
...
def write_broker_dispatch_send_packet(
    *,
    ...
    report = evaluate_broker_dispatch_send_packet(
        ...
        dispatch_orders=_read_dispatch_orders(dispatch_orders_path),
    ...
    for name, key in (
        ("dispatch_upload_contract_identity", "identity_path"),
        ("dispatch_upload_manifest", "manifest_path"),
        ("dispatch_upload_config", "config_path"),
    ):
        path = identity_evidence.get(key)
    ...
    write_experiment_manifest(
        ...
        extra={
            ...
            **_contract_identity_manifest_fields(report.summary.iloc[0]),
...
def _request_rows(
    ...
    identity_active = bool(identity_state and identity_state.get("active", False))
    for index, order in dispatch_orders.reset_index(drop=True).iterrows():
        payload, payload_error = _order_payload(order)
        identity_fields = (
            _contract_identity_request_fields(order)
            if identity_active
            else {}
        )
        envelope = {
        ...
        if identity_active:
            envelope["contract_identity"] = identity_fields
...
def _expected_ack_template(requests: pd.DataFrame) -> pd.DataFrame:
    identity_columns = [
        column
        for column in CONTRACT_IDENTITY_REQUEST_COLUMNS
        if column in requests.columns
    ]
    if requests.empty:
        return pd.DataFrame(
            columns=[
...
def _contract_identity_request_fields(row: pd.Series) -> dict[str, Any]:
    return {
        request_column: _contract_identity_value(
            row.get(dispatch_column),
            request_column,
        )
        for dispatch_column, request_column in CONTRACT_IDENTITY_COLUMNS
    }


def _source_contract_identity_request_fields(row: pd.Series) -> dict[str, Any]:
    return {
        request_column: _contract_identity_value(
            row.get(
                "row_number"
                if dispatch_column == "contract_identity_row_number"
                else dispatch_column
            ),
            request_column,
        )
        for dispatch_column, request_column in CONTRACT_IDENTITY_COLUMNS
...
def _request_contract_identity_fields(row: pd.Series) -> dict[str, Any]:
    return {
...
def _contract_identity_value(value: object, column: str) -> Any:
    if column in CONTRACT_IDENTITY_BOOLEAN_COLUMNS:
        return _to_bool(value)
    if column in CONTRACT_IDENTITY_INTEGER_COLUMNS:
        return _optional_int(value)
    return _object_text(value).strip()
...
def _contract_identity_records(
    frame: pd.DataFrame,
    *,
    source: str,
) -> list[dict[str, Any]]:
    ...
    if source == "dispatch":
        return [
            _contract_identity_request_fields(row)
            for _index, row in frame.reset_index(drop=True).iterrows()
        ]
    if source == "upload":
        return [
            _source_contract_identity_request_fields(row)
            for _index, row in frame.reset_index(drop=True).iterrows()
        ]
    return [
        _request_contract_identity_fields(row)
        for _index, row in frame.reset_index(drop=True).iterrows()
    ]


def _contract_identity_sha256(records: list[dict[str, Any]]) -> str:
    if not records:
        return ""
...
def _contract_identity_state(
    dispatch_summary: pd.Series,
    dispatch_orders: pd.DataFrame,
    upload_contract_identity: pd.DataFrame | None,
    evidence: dict[str, Any] | None,
) -> dict[str, Any]:
    evidence = dict(evidence or {})
    identity_columns_present = all(
        dispatch_column in dispatch_orders.columns
        for dispatch_column, _request_column in CONTRACT_IDENTITY_COLUMNS
    )
    source_present = upload_contract_identity is not None
    active = bool(
        _to_bool(dispatch_summary.get("upload_contract_identity_active", False))
        or evidence.get("active", False)
        or identity_columns_present
        or source_present
    )
    required = _to_bool(
        dispatch_summary.get("upload_contract_identity_required", False)
    )
    provided = _to_bool(
        dispatch_summary.get("upload_contract_identity_provided", False)
    )
    token_required = _to_bool(
        dispatch_summary.get("upload_contract_identity_token_required", False)
    )
    gate_required = bool(
        _to_bool(
            dispatch_summary.get(
                "upload_contract_identity_gate_required",
    ...
    proof_required = bool(
        _to_bool(
            dispatch_summary.get("upload_contract_identity_proof_required", False)
        )
        or evidence.get("proof_required", False)
    )
    dispatch_records = (
        _contract_identity_records(dispatch_orders, source="dispatch")
        if identity_columns_present
        else []
    )
    source_records = (
        _contract_identity_records(upload_contract_identity, source="upload")
        if upload_contract_identity is not None
        else []
    )
    order_count = int(len(dispatch_orders))
    row_numbers = [
        record["contract_identity_row_number"]
        for record in dispatch_records
    ]
    row_numbers_match = bool(
        len(dispatch_records) == order_count
        and row_numbers == list(range(order_count))
    )
    ready_orders = sum(
        bool(record["resolution_row_ready"]) for record in dispatch_records
    )
    token_orders = sum(
        bool(record["broker_instrument_token"]) for record in dispatch_records
    )
    research_id_orders = sum(
        bool(record["research_instrument_id"]) for record in dispatch_records
    )
    broker_id_orders = sum(
        bool(record["broker_instrument_id"]) for record in dispatch_records
    )
    upload_ids_match = bool(
        dispatch_records
        and all(
            record["upload_identity_matches"]
            and record["broker_instrument_id"]
            and record["broker_instrument_id"] == record["upload_instrument_id"]
            for record in dispatch_records
        )
    )
    summary_counts_match = bool(
        int(_number(dispatch_summary, "upload_contract_identity_orders", 0.0))
        == order_count
        and int(
            _number(
                dispatch_summary,
                "upload_contract_identity_ready_orders",
                0.0,
            )
        )
        == ready_orders
        and int(
            _number(
                dispatch_summary,
                "upload_contract_identity_token_orders",
                0.0,
            )
        )
        == token_orders
    )
    route_adapter = _identity_key(dispatch_summary.get("adapter", ""))
    dispatch_identity_adapter = _identity_key(
        dispatch_summary.get("upload_contract_identity_adapter", "")
    )
    source_adapter = _identity_key(evidence.get("adapter", ""))
    adapter_matches = bool(
        not proof_required
        or (
            route_adapter
            and dispatch_identity_adapter == route_adapter
            and source_adapter == route_adapter
        )
    )
    source_matches_dispatch = bool(
        source_present
        and len(source_records) == len(dispatch_records)
        and source_records == dispatch_records
    )
    source_identity_sha256 = _object_text(
        evidence.get("identity_sha256", "")
    ).strip()
    source_manifest_sha256 = _object_text(
        evidence.get("manifest_sha256", "")
    ).strip()
    proof_hashes_match = bool(
        not proof_required
        or (
            source_identity_sha256
            and source_identity_sha256
            == _text(dispatch_summary, "upload_contract_identity_sha256")
            and source_manifest_sha256
            and source_manifest_sha256
            == _text(dispatch_summary, "upload_pack_manifest_sha256")
        )
    )
    source_manifest_current = _to_bool(
        evidence.get("manifest_current", not proof_required)
    )
    source_artifacts_consistent = _to_bool(
        evidence.get("artifacts_consistent", not proof_required)
    )
    source_proof_passed = bool(
        not proof_required
        or (
            source_present
            and source_manifest_current
            and source_artifacts_consistent
            and _to_bool(evidence.get("passed", False))
            and proof_hashes_match
        )
    )
    resolution_ready = bool(
        order_count > 0
        and ready_orders == order_count
        and research_id_orders == order_count
        and broker_id_orders == order_count
        and upload_ids_match
        and (token_orders == order_count if token_required else True)
    )
    dispatch_gate_passed = _to_bool(
        dispatch_summary.get("upload_contract_identity_gate_passed", False)
    )
    base_gate_passed = bool(
        ...
        or (
            ...
            and len(dispatch_records) == order_count
            and row_numbers_match
            and summary_counts_match
            and adapter_matches
            and source_proof_passed
            and (source_matches_dispatch if proof_required else True)
    ...
    return {
        ...
        "dispatch_orders": order_count,
        "identity_orders": len(dispatch_records),
        "ready_orders": ready_orders,
        "research_id_orders": research_id_orders,
        "broker_id_orders": broker_id_orders,
        ...
        "source_matches_dispatch": source_matches_dispatch,
        "source_manifest_current": source_manifest_current,
        "source_artifacts_consistent": source_artifacts_consistent,
        "source_proof_passed": source_proof_passed,
        "proof_hashes_match": proof_hashes_match,
        "source_identity_path": _object_text(
            evidence.get("identity_path", "")
        ).strip(),
        "source_identity_sha256": source_identity_sha256,
        "source_manifest_path": _object_text(
            evidence.get("manifest_path", "")
        ).strip(),
        "source_manifest_sha256": source_manifest_sha256,
        "source_consistency_error": _object_text(
            evidence.get("consistency_error", "")
        ).strip(),
        "resolution_ready": resolution_ready,
        "contract_identity_sha256": _contract_identity_sha256(dispatch_records),
        "base_gate_passed": base_gate_passed,
        "request_columns_present": not active,
        "request_matches_dispatch": not active,
        "request_payload_matches": not active,
        "request_order_payload_isolated": not active,
        "expected_ack_columns_present": not active,
        "expected_ack_matches_requests": not active,
        "request_identity_orders": 0,
        "expected_ack_identity_orders": 0,
        "gate_passed": base_gate_passed,
    }


def _complete_contract_identity_state(
    state: dict[str, Any],
    dispatch_orders: pd.DataFrame,
    requests: pd.DataFrame,
    expected_acks: pd.DataFrame,
    ...
    request_columns_present = all(
        column in requests.columns for column in CONTRACT_IDENTITY_REQUEST_COLUMNS
    )
    expected_ack_columns_present = all(
        column in expected_acks.columns
        for column in CONTRACT_IDENTITY_REQUEST_COLUMNS
    )
    dispatch_records = _contract_identity_records(
        dispatch_orders,
        source="dispatch",
    )
    request_records = (
        _contract_identity_records(requests, source="request")
        if request_columns_present
        else []
    )
    expected_ack_records = (
        _contract_identity_records(expected_acks, source="request")
        if expected_ack_columns_present
        else []
    )
    request_matches_dispatch = bool(request_records == dispatch_records)
    expected_ack_matches_requests = bool(expected_ack_records == request_records)
    request_payload_matches = _request_payload_contract_identity_matches(
        requests,
        request_records,
    )
    request_order_payload_isolated = _request_order_payload_identity_isolated(
        requests
    )
    state.update(
        {
            "request_columns_present": request_columns_present,
            "request_matches_dispatch": request_matches_dispatch,
            "request_payload_matches": request_payload_matches,
            "request_order_payload_isolated": request_order_payload_isolated,
            "expected_ack_columns_present": expected_ack_columns_present,
            "expected_ack_matches_requests": expected_ack_matches_requests,
            "request_identity_orders": len(request_records),
            "expected_ack_identity_orders": len(expected_ack_records),
            "gate_passed": bool(
                state["base_gate_passed"]
                and request_columns_present
                and request_matches_dispatch
                and request_payload_matches
                and request_order_payload_isolated
                and expected_ack_columns_present
                and expected_ack_matches_requests
            ),
        }
    )
    return state
...
def _request_payload_contract_identity_matches(
    requests: pd.DataFrame,
    expected_records: list[dict[str, Any]],
) -> bool:
    if len(requests) != len(expected_records):
        return False
    for raw, expected in zip(
        requests.get("request_payload_json", pd.Series(dtype=str)),
        expected_records,
    ):
        try:
            payload = json.loads(_object_text(raw))
        ...
        if not isinstance(identity, dict):
            return False
        actual = {
            column: _contract_identity_value(identity.get(column), column)
            for column in CONTRACT_IDENTITY_REQUEST_COLUMNS
        }
        if actual != expected:
            return False
...
def _request_order_payload_identity_isolated(requests: pd.DataFrame) -> bool:
    for raw in requests.get("request_payload_json", pd.Series(dtype=str)):
        try:
            payload = json.loads(_object_text(raw))
        except (TypeError, ValueError, json.JSONDecodeError):
            return False
        ...
        if not isinstance(order, dict):
            return False
        if INTERNAL_IDENTITY_ORDER_FIELDS.intersection(order):
            return False
    return True


def _contract_identity_state_fields(state: dict[str, Any]) -> dict[str, Any]:
    return {
        "send_contract_identity_active": bool(state["active"]),
        "send_contract_identity_required": bool(state["required"]),
        "send_contract_identity_provided": bool(state["provided"]),
        "send_contract_identity_token_required": bool(state["token_required"]),
        "send_contract_identity_gate_required": bool(state["gate_required"]),
        "send_contract_identity_proof_required": bool(state["proof_required"]),
        "send_contract_identity_dispatch_gate_passed": bool(
            state["dispatch_gate_passed"]
        ),
        "send_contract_identity_source_present": bool(state["source_present"]),
        "send_contract_identity_source_manifest_current": bool(
            state["source_manifest_current"]
        ),
        "send_contract_identity_source_artifacts_consistent": bool(
            state["source_artifacts_consistent"]
        ),
        "send_contract_identity_source_matches_dispatch": bool(
            state["source_matches_dispatch"]
        ),
        "send_contract_identity_proof_hashes_match": bool(
            state["proof_hashes_match"]
        ),
        "send_contract_identity_adapter_matches": bool(state["adapter_matches"]),
        "send_contract_identity_dispatch_orders": int(state["dispatch_orders"]),
        "send_contract_identity_ready_orders": int(state["ready_orders"]),
        "send_contract_identity_token_orders": int(state["token_orders"]),
        "send_contract_identity_request_orders": int(
            state["request_identity_orders"]
        ),
        "send_contract_identity_expected_ack_orders": int(
            state["expected_ack_identity_orders"]
        ),
        "send_contract_identity_requests_match_dispatch": bool(
            state["request_matches_dispatch"]
        ),
        "send_contract_identity_payloads_match_requests": bool(
            state["request_payload_matches"]
        ),
        "send_contract_identity_vendor_order_isolated": bool(
            state["request_order_payload_isolated"]
        ),
        "send_contract_identity_expected_acks_match_requests": bool(
            state["expected_ack_matches_requests"]
        ),
        "send_contract_identity_sha256": _object_text(
            state["contract_identity_sha256"]
        ).strip(),
        "send_contract_identity_source_sha256": _object_text(
            state["source_identity_sha256"]
        ).strip(),
        "send_contract_identity_source_manifest_sha256": _object_text(
            state["source_manifest_sha256"]
        ).strip(),
        "send_contract_identity_consistency_error": _object_text(
            state["source_consistency_error"]
        ).strip(),
        "send_contract_identity_gate_passed": bool(state["gate_passed"]),
    }
...
def _dispatch_summary_state(row: pd.Series, config: dict[str, Any]) -> pd.Series:
    ...
    contract_identity = upload.get("contract_identity", {}) or {}
    if isinstance(contract_identity, dict) and contract_identity:
        identity_fields = {
            ...
            "sidecar_path": "upload_contract_identity_file",
        ...
        for source, target in identity_fields.items():
            if source not in contract_identity:
                continue
            value = contract_identity[source]
            if source in boolean_fields:
                state[target] = _to_bool(value)
            elif source in integer_fields:
                state[target] = int(_number_value(value, _number(state, target, 0.0)))
            else:
                state[target] = _object_text(value).strip()
    ...
    broker_vendor_current_latest_extended_complete_final_lineage_54 = (
        _broker_vendor_current_latest_extended_complete_final_lineage_54_state(
            state,
            config,
        )
    )
    broker_vendor_reconciled_current_latest_extended_complete_final_lineage_62 = (
        _broker_vendor_reconciled_current_latest_extended_complete_final_lineage_62_state(
            state,
            config,
        )
    )
    broker_vendor_verified_reconciled_current_latest_extended_complete_final_lineage_70 = (
        _broker_vendor_verified_reconciled_current_latest_extended_complete_final_lineage_70_state(
            state,
            config,
        )
    )
    broker_vendor_confirmed_verified_reconciled_current_latest_extended_complete_final_lineage_78 = (
        _broker_vendor_confirmed_verified_reconciled_current_latest_extended_complete_final_lineage_78_state(
            state,
            config,
        )
    )
    ...
    for field, value in broker_vendor_latest_extended_complete_final_lineage_46.items():
        state[field] = value
    for field, value in broker_vendor_current_latest_extended_complete_final_lineage_54.items():
        state[field] = value
    for field, value in broker_vendor_reconciled_current_latest_extended_complete_final_lineage_62.items():
        state[field] = value
    for field, value in broker_vendor_verified_reconciled_current_latest_extended_complete_final_lineage_70.items():
        state[field] = value
    for field, value in broker_vendor_confirmed_verified_reconciled_current_latest_extended_complete_final_lineage_78.items():
        state[field] = value
    return state
...
def _broker_vendor_current_latest_extended_complete_final_lineage_54_comparison_source(
    config: dict[str, Any],
) -> dict[str, Any]:
    comparison = config.get(
        DISPATCH_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_54_COMPARISON_KEY
...
def _broker_vendor_reconciled_current_latest_extended_complete_final_lineage_62_comparison_source(
    config: dict[str, Any],
) -> dict[str, Any]:
    comparison = config.get(
        DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_COMPARISON_KEY
...
def _broker_vendor_verified_reconciled_current_latest_extended_complete_final_lineage_70_comparison_source(
    config: dict[str, Any],
) -> dict[str, Any]:
    comparison = config.get(
        DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_COMPARISON_KEY
...
def _broker_vendor_confirmed_verified_reconciled_current_latest_extended_complete_final_lineage_78_comparison_source(
    config: dict[str, Any],
) -> dict[str, Any]:
    comparison = config.get(
        DISPATCH_CONFIRMED_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_78_COMPARISON_KEY
...
def _broker_vendor_current_latest_extended_complete_final_lineage_54_state(
    row: pd.Series,
    config: dict[str, Any],
) -> dict[str, object]:
    comparison = (
        _broker_vendor_current_latest_extended_complete_final_lineage_54_comparison_source(
            config
        )
    )
    prefix = DISPATCH_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_54_FIELD_PREFIX
    summary_prefix = (
        DISPATCH_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_54_SUMMARY_FIELD_PREFIX
    )
    fields: dict[str, object] = {
...
def _broker_vendor_reconciled_current_latest_extended_complete_final_lineage_62_state(
    row: pd.Series,
    config: dict[str, Any],
) -> dict[str, object]:
    comparison = (
        _broker_vendor_reconciled_current_latest_extended_complete_final_lineage_62_comparison_source(
            config
        )
    )
    prefix = (
    ...
    fields: dict[str, object] = {
        ...
        f"{prefix}_carried_application_lineage_sha256": _sha256_text(
            _first_text(
                comparison.get("carried_application_lineage_sha256", ""),
                row.get(f"{summary_prefix}_{dispatch_review_field}", ""),
            )
        ),
    }
    for field in (
...
def _broker_vendor_verified_reconciled_current_latest_extended_complete_final_lineage_70_state(
    row: pd.Series,
    config: dict[str, Any],
) -> dict[str, object]:
    comparison = (
        _broker_vendor_verified_reconciled_current_latest_extended_complete_final_lineage_70_comparison_source(
            config
        )
    )
    prefix = (
    ...
    for field in (
        *DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_DIGEST_FIELDS,
        *DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_STAGE_FIELDS,
        *DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_CURRENT_STAGE_FIELDS,
        *DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_REVIEW_FIELDS,
        DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_ACK_REVIEW_FIELD,
        DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_ROUNDTRIP_REVIEW_FIELD,
        DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_BROKER_READINESS_REVIEW_FIELD,
        DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_SCALEUP_REVIEW_FIELD,
...
def _broker_vendor_confirmed_verified_reconciled_current_latest_extended_complete_final_lineage_78_state(
    row: pd.Series,
    config: dict[str, Any],
) -> dict[str, object]:
    comparison = (
        _broker_vendor_confirmed_verified_reconciled_current_latest_extended_complete_final_lineage_78_comparison_source(
            config
        )
    )
    prefix = (
    ...
    for field in (
        ...
        *DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_REVIEW_FIELDS,
        ...
        DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_ROUTE_REVIEW_FIELD,
        DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_DISPATCH_REVIEW_FIELD,
        *DISPATCH_CONFIRMED_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_78_REVIEW_FIELDS,
        DISPATCH_CONFIRMED_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_78_DISPATCH_REVIEW_FIELD,
    ):
        fields[f"{prefix}_{field}"] = _sha256_text(
            _first_text(
...
def _checks(
    ...
    if identity_state and identity_state["active"]:
        identity_checks = [
            _check(
                "dispatch_contract_identity_gate_passed",
                identity_state["dispatch_gate_passed"],
                "is",
                True,
                bool(identity_state["dispatch_gate_passed"]),
                "broker dispatch did not retain a passing upload contract-identity gate",
            ),
            _check(
                "dispatch_contract_identity_columns_present",
                identity_state["identity_orders"],
                "==",
                identity_state["dispatch_orders"],
                bool(
                    identity_state["identity_columns_present"]
                    and identity_state["identity_orders"]
                    == identity_state["dispatch_orders"]
                ),
                "broker dispatch rows are missing contract-identity audit columns",
            ),
            _check(
                "dispatch_contract_identity_row_numbers",
                identity_state["row_numbers_match"],
                "is",
                True,
                bool(identity_state["row_numbers_match"]),
                "broker dispatch contract-identity row numbers are incomplete or reordered",
            ),
            _check(
                "dispatch_contract_identity_summary_counts",
                identity_state["summary_counts_match"],
                "is",
                True,
                bool(identity_state["summary_counts_match"]),
                "broker dispatch contract-identity counts disagree with its order rows",
            ),
            _check(
                "dispatch_contract_identity_adapter_matches",
                identity_state["adapter_matches"],
                "is",
                True,
                bool(identity_state["adapter_matches"]),
                "upload-pack contract identity adapter does not match the dispatch route",
            ),
            _check(
                "send_contract_identity_requests_match_dispatch",
                identity_state["request_identity_orders"],
                "==",
                identity_state["dispatch_orders"],
                bool(
                    identity_state["request_columns_present"]
                    and identity_state["request_matches_dispatch"]
                ),
                "send requests do not preserve broker dispatch contract identity",
            ),
            _check(
                "send_contract_identity_payloads_match_requests",
                identity_state["request_payload_matches"],
                "is",
                True,
                bool(identity_state["request_payload_matches"]),
                "send request envelopes do not match their contract-identity audit columns",
            ),
            _check(
                "send_contract_identity_vendor_order_isolated",
                identity_state["request_order_payload_isolated"],
                "is",
                True,
                bool(identity_state["request_order_payload_isolated"]),
                "internal contract identity leaked into the vendor order body",
            ),
            _check(
                "send_contract_identity_expected_acks_match_requests",
                identity_state["expected_ack_identity_orders"],
                "==",
                identity_state["request_identity_orders"],
                bool(
                    identity_state["expected_ack_columns_present"]
                    and identity_state["expected_ack_matches_requests"]
                ),
                "expected acknowledgements do not preserve send request contract identity",
            ),
        ]
        if identity_state["proof_required"]:
            identity_checks[5:5] = [
                _check(
                    "upload_contract_identity_source_present",
                    identity_state["source_present"],
                    "is",
                    True,
                    bool(identity_state["source_present"]),
                    "manifest-bound upload contract-identity evidence is missing",
                ),
                _check(
                    "upload_contract_identity_manifest_current",
                    identity_state["source_manifest_current"],
                    "is",
                    True,
                    bool(identity_state["source_manifest_current"]),
                    "upload-pack manifest is stale or incomplete at send time",
                ),
                _check(
                    "upload_contract_identity_artifacts_consistent",
                    identity_state["source_artifacts_consistent"],
                    "is",
                    True,
                    bool(identity_state["source_artifacts_consistent"]),
                    "upload-pack artifacts no longer reconstruct from broker-order evidence",
                ),
                _check(
                    "upload_contract_identity_proof_hashes_match",
                    identity_state["proof_hashes_match"],
                    "is",
                    True,
                    bool(identity_state["proof_hashes_match"]),
                    "dispatch identity proof hashes do not match the current upload pack",
                ),
                _check(
                    "upload_contract_identity_matches_dispatch",
                    identity_state["source_matches_dispatch"],
                    "is",
                    True,
                    bool(identity_state["source_matches_dispatch"]),
                    "dispatch contract identity differs from the verified upload sidecar",
                ),
            ]
        if identity_state["gate_required"]:
            identity_checks.append(
                _check(
                    "send_contract_identity_resolution_ready",
                    identity_state["ready_orders"],
                    "==",
                    identity_state["dispatch_orders"],
                    bool(identity_state["resolution_ready"]),
                    "one or more send requests lost verified broker instrument resolution",
                )
            )
        checks = pd.concat(
    ...
    if _to_bool(dispatch_summary.get("broker_dispatch_lineage_required", False)):
        ...
        route_enable_route_identity_active = _to_bool(
            dispatch_summary.get(
                (
        ...
        route_enable_route_identity_sha256 = _object_text(
            dispatch_summary.get(
                (
        ...
        current_route_enable_route_identity_sha256 = _object_text(
            dispatch_summary.get(
                (
                    "broker_dispatch_current_route_enable_"
                    "route_contract_identity_sha256"
                ),
                "",
            )
        ).strip()
        route_enable_route_enable_identity_active = _to_bool(
            dispatch_summary.get(
                (
        ...
        route_enable_route_enable_identity_sha256 = _object_text(
            dispatch_summary.get(
                (
                    "broker_dispatch_route_enable_cutover_runtime_telemetry_"
        ...
        current_route_enable_route_enable_identity_sha256 = _object_text(
            dispatch_summary.get(
                (
                ...
                pd.DataFrame(
                    [
                        ...
                        *(
                            [
                                _check(
                                    ...
                                    route_enable_route_identity_sha256,
                                    "present",
                                    True,
                                    bool(route_enable_route_identity_sha256),
                                    (
                                        "broker-dispatch broker route contract "
                                        "identity digest is missing"
                                    ),
                                ),
                                _check(
                                    ...
                                    route_enable_route_identity_sha256,
                                    "==",
                                    current_route_enable_route_identity_sha256,
                                    bool(
                                        route_enable_route_identity_sha256
                                        and current_route_enable_route_identity_sha256
                                        and route_enable_route_identity_sha256
                                        == current_route_enable_route_identity_sha256
                                    ),
                                    (
                                        "broker-dispatch broker route contract "
                                        "identity digest differs from the "
                                        "current route-enable source"
                                    ),
                                ),
                                _check(
                                    (
                                        "broker_dispatch_route_enable_route_"
                                        "contract_identity_matches_current"
                                    ),
                                    _to_bool(
                                        dispatch_summary.get(
                            ...
                            if route_enable_route_identity_active
                            else []
                        ),
                        *(
                            [
                                _check(
                                    ...
                                    route_enable_route_enable_identity_sha256,
                                    "present",
                                    True,
                                    bool(
                                        route_enable_route_enable_identity_sha256
                                    ...
                                    (
                                        ...
                                        "route contract identity digest is "
                                        "missing"
                                    ),
                                ),
                                _check(
                                    ...
                                    (
                                        ...
                                        "differs from the current route-enable "
                                        "source"
                                    ),
                                ),
                                _check(
                                    ...
                                    (
                                        "broker-dispatch broker route-enable "
                                        "route contract identity no longer "
                                        "matches the current route-enable "
                                        "source"
                                    ),
                                ),
                            ]
                        ...
                        *(
                            ...
                            if _to_bool(
                                dispatch_summary.get(
                                    "broker_dispatch_route_enable_cutover_broker_readiness_required",
                                    False,
                                )
                            )
                            else []
        ...
        if lineage_consistency_required:
            checks.extend(
                [
                    ...
                    *_broker_vendor_current_latest_extended_complete_final_lineage_54_checks(
                        dispatch_summary,
                        send_lineage_sha256=send_carried_lineage_sha256,
                    ),
                    *_broker_vendor_reconciled_current_latest_extended_complete_final_lineage_62_checks(
                        dispatch_summary,
                        send_lineage_sha256=send_carried_lineage_sha256,
                    ),
                    *_broker_vendor_verified_reconciled_current_latest_extended_complete_final_lineage_70_checks(
                        dispatch_summary,
                        send_lineage_sha256=send_carried_lineage_sha256,
                    ),
                    *_broker_vendor_confirmed_verified_reconciled_current_latest_extended_complete_final_lineage_78_checks(
                        dispatch_summary,
                        send_lineage_sha256=send_carried_lineage_sha256,
                    ),
                ]
...
def _broker_vendor_current_latest_extended_complete_final_lineage_54_checks(
    dispatch_summary: pd.Series,
    *,
    send_lineage_sha256: str,
) -> list[dict[str, object]]:
    source_prefix = DISPATCH_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_54_FIELD_PREFIX
    compatibility_prefix = DISPATCH_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_46_FIELD_PREFIX
    check_prefix = (
        f"{DISPATCH_FINAL_LINEAGE_FIELD_PREFIX}_"
    ...
    compatibility_send_latest_lineage_sha256 = _sha256_text(send_lineage_sha256)
    checks = [
        _check(
            f"{check_prefix}_lineage_match_required",
            lineage_match_required,
            ...
            True,
            lineage_match_required,
            "reconciled target send preparation requires broker dispatch's current latest extended complete-final lineage comparison",
        ),
        _check(
            f"{check_prefix}_lineage_matches",
            lineage_matches,
            ...
            True,
            bool(lineage_match_required and lineage_matches),
            "broker dispatch did not match every current latest extended complete-final target-lineage view",
        ),
        _check(
            f"{check_prefix}_source_lineage_sha256_matches",
            current_lineage_sha256,
            ...
            "broker dispatch current latest extended complete-final source lineage does not match final broker proof",
        ),
        _check(
            f"{check_prefix}_compatibility_broker_lineage_sha256_matches",
            compatibility_broker_lineage_sha256,
            ...
            "send compatibility broker digest does not match dispatch's current latest proof",
        ),
        _check(
            f"{check_prefix}_compatibility_send_latest_extended_complete_final_review_carried_lineage_sha256_matches",
            compatibility_send_latest_lineage_sha256,
            "==",
            broker_lineage_sha256,
            bool(
                lineage_match_required
                and compatibility_send_latest_lineage_sha256
                and broker_lineage_sha256
                and compatibility_send_latest_lineage_sha256
                == broker_lineage_sha256
            ),
            "send compatibility latest review does not match dispatch's current proof",
        ),
    ]
    for field in DISPATCH_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_54_DIGEST_FIELDS:
        if field in {
            "current_application_lineage_sha256",
            "broker_application_lineage_sha256",
        }:
    ...
    for field in DISPATCH_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_54_STAGE_FIELDS:
        stage = field.removesuffix("_carried_application_lineage_sha256")
        carried_sha256 = _sha256_text(
            dispatch_summary.get(f"{source_prefix}_{field}", "")
        )
    ...
    dispatch_current_latest_generic_lineage_sha256 = _sha256_text(
        dispatch_summary.get(f"{source_prefix}_carried_application_lineage_sha256", "")
    )
    send_current_latest_lineage_sha256 = _sha256_text(send_lineage_sha256)
    checks.extend(
        [
            _check(
                ...
                "broker dispatch's source scale-up current latest review lineage does not match final broker proof",
            ),
            _check(
                ...
                "broker dispatch's source cutover current latest review lineage does not match final broker proof",
            ),
            _check(
                ...
                "broker dispatch's source route current latest review lineage does not match final broker proof",
            ),
            _check(
                ...
                "broker dispatch's current latest review lineage does not match final broker proof",
            ),
            _check(
                f"{check_prefix}_dispatch_current_latest_extended_complete_final_review_generic_carried_lineage_sha256_matches",
                dispatch_current_latest_generic_lineage_sha256,
                "==",
                broker_lineage_sha256,
                bool(
                    lineage_match_required
                    and dispatch_current_latest_generic_lineage_sha256
                    and broker_lineage_sha256
                    and dispatch_current_latest_generic_lineage_sha256
                    == broker_lineage_sha256
                ),
                "broker dispatch's generic current latest review lineage does not match final broker proof",
            ),
            _check(
                f"{check_prefix}_send_current_latest_extended_complete_final_review_carried_lineage_sha256_matches",
                send_current_latest_lineage_sha256,
                "==",
                broker_lineage_sha256,
                bool(
                    lineage_match_required
                    and send_current_latest_lineage_sha256
                    and broker_lineage_sha256
                    and send_current_latest_lineage_sha256
                    == broker_lineage_sha256
                ),
                "send preparation's independently recomputed target lineage does not match dispatch's current latest proof",
            ),
        ]
    )
    return checks
...
def _broker_vendor_reconciled_current_latest_extended_complete_final_lineage_62_checks(
    dispatch_summary: pd.Series,
    *,
    send_lineage_sha256: str,
) -> list[dict[str, object]]:
    ...
    compatibility_send_current_lineage_sha256 = _sha256_text(send_lineage_sha256)
    checks = [
        _check(
            f"{check_prefix}_lineage_match_required",
            lineage_match_required,
            ...
            True,
            lineage_match_required,
            "reconciled target send preparation requires broker dispatch's reconciled current latest extended complete-final lineage comparison",
        ),
        _check(
            f"{check_prefix}_lineage_matches",
            lineage_matches,
            ...
            True,
            bool(lineage_match_required and lineage_matches),
            "broker dispatch did not match every reconciled current latest extended complete-final target-lineage view",
        ),
        _check(
            f"{check_prefix}_source_lineage_sha256_matches",
            current_lineage_sha256,
            ...
            "broker dispatch reconciled current latest extended complete-final source lineage does not match final broker proof",
        ),
        _check(
            f"{check_prefix}_compatibility_broker_lineage_sha256_matches",
            compatibility_broker_lineage_sha256,
            ...
            "send compatibility broker digest does not match dispatch's reconciled current proof",
        ),
        _check(
            f"{check_prefix}_compatibility_send_current_latest_extended_complete_final_review_carried_lineage_sha256_matches",
            compatibility_send_current_lineage_sha256,
            "==",
            broker_lineage_sha256,
            bool(
                lineage_match_required
                and compatibility_send_current_lineage_sha256
                and broker_lineage_sha256
                and compatibility_send_current_lineage_sha256
                == broker_lineage_sha256
            ),
            "send compatibility current review does not match dispatch's reconciled current proof",
        ),
    ]
    for field in DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_DIGEST_FIELDS:
        if field in {
            "current_application_lineage_sha256",
            "broker_application_lineage_sha256",
        }:
    ...
    broker_readiness_reconciled_lineage_sha256 = _sha256_text(
        dispatch_summary.get(
            f"{source_prefix}_{DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_BROKER_READINESS_REVIEW_FIELD}",
            "",
        )
    )
    scaleup_reconciled_lineage_sha256 = _sha256_text(
        dispatch_summary.get(
            f"{source_prefix}_{DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_SCALEUP_REVIEW_FIELD}",
            "",
        )
    )
    cutover_reconciled_lineage_sha256 = _sha256_text(
        dispatch_summary.get(
            f"{source_prefix}_{DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_CUTOVER_REVIEW_FIELD}",
            "",
        )
    )
    route_reconciled_lineage_sha256 = _sha256_text(
        dispatch_summary.get(
            f"{source_prefix}_{DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_ROUTE_REVIEW_FIELD}",
            "",
        )
    )
    dispatch_reconciled_lineage_sha256 = _sha256_text(
        dispatch_summary.get(
            f"{source_prefix}_{DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_DISPATCH_REVIEW_FIELD}",
            "",
        )
    )
    dispatch_reconciled_generic_lineage_sha256 = _sha256_text(
        dispatch_summary.get(f"{source_prefix}_carried_application_lineage_sha256", "")
    )
    send_reconciled_lineage_sha256 = _sha256_text(send_lineage_sha256)
    checks.extend(
        [
            _check(
            ...
            _check(
                f"{check_prefix}_dispatch_reconciled_current_latest_extended_complete_final_review_generic_carried_lineage_sha256_matches",
                dispatch_reconciled_generic_lineage_sha256,
                "==",
                broker_lineage_sha256,
                bool(
                    lineage_match_required
                    and dispatch_reconciled_generic_lineage_sha256
                    and broker_lineage_sha256
                    and dispatch_reconciled_generic_lineage_sha256
                    == broker_lineage_sha256
                ),
                "broker dispatch's generic reconciled current review lineage does not match final broker proof",
            ),
            _check(
                f"{check_prefix}_send_reconciled_current_latest_extended_complete_final_review_carried_lineage_sha256_matches",
                send_reconciled_lineage_sha256,
                "==",
                broker_lineage_sha256,
                bool(
                    lineage_match_required
                    and send_reconciled_lineage_sha256
                    and broker_lineage_sha256
                    and send_reconciled_lineage_sha256 == broker_lineage_sha256
                ),
                "send preparation's independently recomputed target lineage does not match dispatch's reconciled current proof",
            ),
        ]
    )
    return checks
...
def _broker_vendor_verified_reconciled_current_latest_extended_complete_final_lineage_70_checks(
    dispatch_summary: pd.Series,
    *,
    send_lineage_sha256: str,
) -> list[dict[str, object]]:
    ...
    compatibility_send_reconciled_lineage_sha256 = _sha256_text(
        send_lineage_sha256
    )
    checks = [
        _check(
            ...
            True,
            lineage_match_required,
            "verified reconciled target send preparation requires broker dispatch's verified reconciled lineage comparison",
        ),
        _check(
            f"{check_prefix}_lineage_matches",
            lineage_matches,
            ...
            True,
            bool(lineage_match_required and lineage_matches),
            "broker dispatch did not match every verified reconciled target-lineage view",
        ),
        _check(
            f"{check_prefix}_source_lineage_sha256_matches",
            current_lineage_sha256,
            ...
            "broker dispatch verified reconciled source lineage does not match final broker proof",
        ),
        _check(
            f"{check_prefix}_compatibility_broker_lineage_sha256_matches",
            compatibility_broker_lineage_sha256,
            ...
            "send compatibility broker digest does not match dispatch's verified reconciled proof",
        ),
        _check(
            ...
            compatibility_send_reconciled_lineage_sha256,
            "==",
            broker_lineage_sha256,
            bool(
                lineage_match_required
                and compatibility_send_reconciled_lineage_sha256
                and broker_lineage_sha256
                and compatibility_send_reconciled_lineage_sha256
                == broker_lineage_sha256
            ),
            "send compatibility reconciled review does not match dispatch's verified reconciled proof",
        ),
    ]
    for field in DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_DIGEST_FIELDS:
        if field in {
            "current_application_lineage_sha256",
            "broker_application_lineage_sha256",
        }:
    ...
    dispatch_verified_generic_lineage_sha256 = _sha256_text(
        dispatch_summary.get(f"{source_prefix}_carried_application_lineage_sha256", "")
    )
    send_verified_lineage_sha256 = _sha256_text(send_lineage_sha256)
    checks.extend(
        [
            _check(
                f"{check_prefix}_dispatch_verified_reconciled_current_latest_extended_complete_final_review_generic_carried_lineage_sha256_matches",
                dispatch_verified_generic_lineage_sha256,
                "==",
                broker_lineage_sha256,
                bool(
                    lineage_match_required
                    and dispatch_verified_generic_lineage_sha256
                    and broker_lineage_sha256
                    and dispatch_verified_generic_lineage_sha256
                    == broker_lineage_sha256
                ),
                "broker dispatch's generic verified reconciled review lineage does not match final broker proof",
            ),
            _check(
                f"{check_prefix}_send_verified_reconciled_current_latest_extended_complete_final_review_carried_lineage_sha256_matches",
                send_verified_lineage_sha256,
                "==",
                broker_lineage_sha256,
                bool(
                    lineage_match_required
                    and send_verified_lineage_sha256
                    and broker_lineage_sha256
                    and send_verified_lineage_sha256 == broker_lineage_sha256
                ),
                "send preparation's independently recomputed target lineage does not match dispatch's verified reconciled proof",
            ),
        ]
    )
    return checks
...
def _broker_vendor_confirmed_verified_reconciled_current_latest_extended_complete_final_lineage_78_checks(
    dispatch_summary: pd.Series,
    *,
    send_lineage_sha256: str,
) -> list[dict[str, object]]:
    ...
    compatibility_send_verified_lineage_sha256 = _sha256_text(
        send_lineage_sha256
    )
    checks = [
        _check(
            ...
            True,
            lineage_match_required,
            "confirmed verified-reconciled target send preparation requires broker dispatch's confirmed lineage comparison",
        ),
        _check(
            f"{check_prefix}_lineage_matches",
            lineage_matches,
            ...
            True,
            bool(lineage_match_required and lineage_matches),
            "broker dispatch did not match every confirmed verified-reconciled target-lineage view",
        ),
        _check(
            f"{check_prefix}_source_lineage_sha256_matches",
            current_lineage_sha256,
            ...
            "broker dispatch confirmed verified-reconciled source lineage does not match final broker proof",
        ),
        _check(
            f"{check_prefix}_compatibility_broker_lineage_sha256_matches",
            compatibility_broker_lineage_sha256,
            ...
            "send compatibility broker digest does not match dispatch's confirmed verified-reconciled proof",
        ),
        _check(
            ...
            compatibility_send_verified_lineage_sha256,
            "==",
            broker_lineage_sha256,
            bool(
                lineage_match_required
                and compatibility_send_verified_lineage_sha256
                and broker_lineage_sha256
                and compatibility_send_verified_lineage_sha256
                == broker_lineage_sha256
            ),
            "send compatibility verified review does not match dispatch's confirmed verified-reconciled proof",
        ),
    ]
    for field in DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_DIGEST_FIELDS:
        if field in {
    ...
    dispatch_confirmed_generic_lineage_sha256 = _sha256_text(
        dispatch_summary.get(f"{source_prefix}_carried_application_lineage_sha256", "")
    )
    send_confirmed_lineage_sha256 = _sha256_text(send_lineage_sha256)
    checks.extend(
        [
            _check(
                f"{check_prefix}_dispatch_confirmed_verified_reconciled_current_latest_extended_complete_final_review_generic_carried_lineage_sha256_matches",
                dispatch_confirmed_generic_lineage_sha256,
                "==",
                broker_lineage_sha256,
                bool(
                    lineage_match_required
                    and dispatch_confirmed_generic_lineage_sha256
                    and broker_lineage_sha256
                    and dispatch_confirmed_generic_lineage_sha256
                    == broker_lineage_sha256
                ),
                "broker dispatch's generic confirmed verified-reconciled review lineage does not match final broker proof",
            ),
            _check(
                ...
                send_confirmed_lineage_sha256,
                "==",
                broker_lineage_sha256,
                bool(
                    lineage_match_required
                    and send_confirmed_lineage_sha256
                    and broker_lineage_sha256
                    and send_confirmed_lineage_sha256 == broker_lineage_sha256
                ),
                "send preparation's independently recomputed target lineage does not match dispatch's confirmed verified-reconciled proof",
            ),
        ]
    )
    return checks
        ...
        [
            {
                ...
                "expected_ack_templates": int(len(expected_acks)),
                **_broker_dispatch_lineage_output_fields(dispatch_summary),
                **(
                    _contract_identity_state_fields(identity_state)
                ...
                **_broker_vendor_current_latest_extended_complete_final_lineage_54_summary_fields(
                    dispatch_summary
                ),
                **_broker_vendor_reconciled_current_latest_extended_complete_final_lineage_62_summary_fields(
                    dispatch_summary
                ),
                **_broker_vendor_verified_reconciled_current_latest_extended_complete_final_lineage_70_summary_fields(
                    dispatch_summary
                ),
                **_broker_vendor_confirmed_verified_reconciled_current_latest_extended_complete_final_lineage_78_summary_fields(
                    dispatch_summary
                ),
                **_vendor_market_data_batch_summary_fields(
                    dispatch_summary,
    ...
    if (
        ...
        or (
            ...
            and (
                ...
                or check.startswith(
                    "broker_dispatch_route_enable_route_contract_identity_"
                )
                or check.startswith(
                    (
                        "broker_dispatch_route_enable_route_enable_"
...
def _action_recommendation(check: str) -> str:
    ...
    if component == "broker_readiness" and check.startswith(
        ...
        return "rebuild_broker_readiness_lineage_before_sender_packet"
    if component == "broker_dispatch_plan":
...
def _broker_vendor_current_latest_extended_complete_final_lineage_54_summary_fields(
    dispatch_summary: pd.Series,
) -> dict[str, object]:
    prefix = DISPATCH_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_54_FIELD_PREFIX
    send_lineage_sha256 = _target_application_lineage_sha256(
    ...
    fields: dict[str, object] = {
        ...
        f"{prefix}_send_current_latest_extended_complete_final_review_carried_application_lineage_sha256": send_lineage_sha256,
    }
    for field in (
        *DISPATCH_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_54_DIGEST_FIELDS,
        *DISPATCH_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_54_STAGE_FIELDS,
...
def _broker_vendor_reconciled_current_latest_extended_complete_final_lineage_62_summary_fields(
    dispatch_summary: pd.Series,
) -> dict[str, object]:
    prefix = (
        DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_FIELD_PREFIX
    ...
    fields: dict[str, object] = {
        ...
        f"{prefix}_{DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_BROKER_READINESS_REVIEW_FIELD}": _sha256_text(
            dispatch_summary.get(
                f"{prefix}_{DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_BROKER_READINESS_REVIEW_FIELD}",
                "",
            )
        ),
        f"{prefix}_{DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_SCALEUP_REVIEW_FIELD}": _sha256_text(
            dispatch_summary.get(
                f"{prefix}_{DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_SCALEUP_REVIEW_FIELD}",
                "",
            )
        ),
        f"{prefix}_{DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_CUTOVER_REVIEW_FIELD}": _sha256_text(
            dispatch_summary.get(
                f"{prefix}_{DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_CUTOVER_REVIEW_FIELD}",
                "",
            )
        ),
        f"{prefix}_{DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_ROUTE_REVIEW_FIELD}": _sha256_text(
            dispatch_summary.get(
                f"{prefix}_{DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_ROUTE_REVIEW_FIELD}",
                "",
            )
        ),
        f"{prefix}_{DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_DISPATCH_REVIEW_FIELD}": _sha256_text(
            dispatch_summary.get(
                f"{prefix}_{DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_DISPATCH_REVIEW_FIELD}",
                "",
            )
        ),
        f"{prefix}_send_reconciled_current_latest_extended_complete_final_review_carried_application_lineage_sha256": send_lineage_sha256,
    }
    for field in (
        *DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_DIGEST_FIELDS,
        *DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_STAGE_FIELDS,
...
def _broker_vendor_verified_reconciled_current_latest_extended_complete_final_lineage_70_summary_fields(
    dispatch_summary: pd.Series,
) -> dict[str, object]:
    prefix = (
        DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_FIELD_PREFIX
    ...
    fields: dict[str, object] = {
        ...
        f"{prefix}_send_verified_reconciled_current_latest_extended_complete_final_review_carried_application_lineage_sha256": send_lineage_sha256,
    }
    for field in (
        *DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_DIGEST_FIELDS,
        *DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_STAGE_FIELDS,
...
def _broker_vendor_confirmed_verified_reconciled_current_latest_extended_complete_final_lineage_78_summary_fields(
    dispatch_summary: pd.Series,
) -> dict[str, object]:
    prefix = (
        DISPATCH_CONFIRMED_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_78_FIELD_PREFIX
    ...
    fields: dict[str, object] = {
        ...
        f"{prefix}_send_confirmed_verified_reconciled_current_latest_extended_complete_final_review_carried_application_lineage_sha256": send_lineage_sha256,
    }
    for field in (
        *DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_DIGEST_FIELDS,
        *DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_STAGE_FIELDS,
...
def _broker_vendor_send_current_latest_extended_complete_final_lineage_55_config(
    summary: pd.Series,
) -> dict[str, object]:
    prefix = DISPATCH_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_54_FIELD_PREFIX
    send_lineage_sha256 = _text(
        summary,
    ...
    config: dict[str, object] = {
        ...
        "send_current_latest_extended_complete_final_review_carried_application_lineage_sha256": send_lineage_sha256,
        "carried_application_lineage_sha256": send_lineage_sha256,
    }
    for field in (
        *DISPATCH_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_54_DIGEST_FIELDS,
        *DISPATCH_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_54_STAGE_FIELDS,
...
def _broker_vendor_send_reconciled_current_latest_extended_complete_final_lineage_63_config(
    summary: pd.Series,
) -> dict[str, object]:
    prefix = (
        DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_FIELD_PREFIX
    ...
    send_lineage_sha256 = _text(
        summary,
        f"{prefix}_send_reconciled_current_latest_extended_complete_final_review_carried_application_lineage_sha256",
    )
    config: dict[str, object] = {
        "required": _to_bool(summary[f"{prefix}_lineage_match_required"]),
        "matches": _to_bool(summary[f"{prefix}_lineage_matches"]),
        DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_BROKER_READINESS_REVIEW_FIELD: _text(
            summary,
            f"{prefix}_{DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_BROKER_READINESS_REVIEW_FIELD}",
        ),
        DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_SCALEUP_REVIEW_FIELD: _text(
            summary,
            f"{prefix}_{DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_SCALEUP_REVIEW_FIELD}",
        ),
        DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_CUTOVER_REVIEW_FIELD: _text(
            summary,
            f"{prefix}_{DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_CUTOVER_REVIEW_FIELD}",
        ),
        DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_ROUTE_REVIEW_FIELD: _text(
            summary,
            f"{prefix}_{DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_ROUTE_REVIEW_FIELD}",
        ),
        DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_DISPATCH_REVIEW_FIELD: _text(
            summary,
            f"{prefix}_{DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_DISPATCH_REVIEW_FIELD}",
        ),
        "send_reconciled_current_latest_extended_complete_final_review_carried_application_lineage_sha256": send_lineage_sha256,
        "carried_application_lineage_sha256": send_lineage_sha256,
    }
    for field in (
        *DISPATCH_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_62_DIGEST_FIELDS,
...
def _broker_vendor_send_verified_reconciled_current_latest_extended_complete_final_lineage_71_config(
    summary: pd.Series,
) -> dict[str, object]:
    prefix = (
        DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_FIELD_PREFIX
    ...
    send_lineage_sha256 = _text(
        summary,
        f"{prefix}_send_verified_reconciled_current_latest_extended_complete_final_review_carried_application_lineage_sha256",
    )
    config: dict[str, object] = {
        "required": _to_bool(summary[f"{prefix}_lineage_match_required"]),
        "matches": _to_bool(summary[f"{prefix}_lineage_matches"]),
        "send_verified_reconciled_current_latest_extended_complete_final_review_carried_application_lineage_sha256": send_lineage_sha256,
        "carried_application_lineage_sha256": send_lineage_sha256,
    }
    for field in (
        *DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_DIGEST_FIELDS,
...
def _broker_vendor_send_confirmed_verified_reconciled_current_latest_extended_complete_final_lineage_79_config(
    summary: pd.Series,
) -> dict[str, object]:
    prefix = (
        DISPATCH_CONFIRMED_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_78_FIELD_PREFIX
    ...
    send_lineage_sha256 = _text(
        summary,
        f"{prefix}_send_confirmed_verified_reconciled_current_latest_extended_complete_final_review_carried_application_lineage_sha256",
    )
    config: dict[str, object] = {
        "required": _to_bool(summary[f"{prefix}_lineage_match_required"]),
        "matches": _to_bool(summary[f"{prefix}_lineage_matches"]),
        "send_confirmed_verified_reconciled_current_latest_extended_complete_final_review_carried_application_lineage_sha256": send_lineage_sha256,
        "carried_application_lineage_sha256": send_lineage_sha256,
    }
    for field in (
        *DISPATCH_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_70_DIGEST_FIELDS,
...
def _contract_identity_config(summary: pd.Series) -> dict[str, Any]:
    return {
        "active": _to_bool(summary.get("send_contract_identity_active", False)),
        "required": _to_bool(
            summary.get("send_contract_identity_required", False)
        ),
        "provided": _to_bool(
            summary.get("send_contract_identity_provided", False)
        ),
        "token_required": _to_bool(
            summary.get("send_contract_identity_token_required", False)
        ),
        "gate_required": _to_bool(
            summary.get("send_contract_identity_gate_required", False)
        ),
        "proof_required": _to_bool(
            summary.get("send_contract_identity_proof_required", False)
        ),
        "dispatch_gate_passed": _to_bool(
            summary.get("send_contract_identity_dispatch_gate_passed", False)
        ),
        "source_present": _to_bool(
            summary.get("send_contract_identity_source_present", False)
        ),
        "source_manifest_current": _to_bool(
            summary.get(
        ...
        "source_matches_dispatch": _to_bool(
            summary.get(
                "send_contract_identity_source_matches_dispatch",
                False,
            )
        ),
        "proof_hashes_match": _to_bool(
            summary.get("send_contract_identity_proof_hashes_match", False)
        ),
        "adapter_matches": _to_bool(
            summary.get("send_contract_identity_adapter_matches", False)
        ),
        "dispatch_orders": int(
            _number(summary, "send_contract_identity_dispatch_orders", 0.0)
        ),
        "ready_orders": int(
            _number(summary, "send_contract_identity_ready_orders", 0.0)
        ),
        "token_orders": int(
            _number(summary, "send_contract_identity_token_orders", 0.0)
        ),
        "request_orders": int(
            _number(summary, "send_contract_identity_request_orders", 0.0)
        ),
        "expected_ack_orders": int(
            _number(
                summary,
                "send_contract_identity_expected_ack_orders",
                0.0,
            )
        ),
        "requests_match_dispatch": _to_bool(
            summary.get(
                "send_contract_identity_requests_match_dispatch",
                False,
            )
        ),
        "payloads_match_requests": _to_bool(
            summary.get(
                "send_contract_identity_payloads_match_requests",
                False,
            )
        ),
        "vendor_order_isolated": _to_bool(
            summary.get("send_contract_identity_vendor_order_isolated", False)
        ),
        "expected_acks_match_requests": _to_bool(
            summary.get(
                "send_contract_identity_expected_acks_match_requests",
                False,
            )
        ),
        "identity_sha256": _text(summary, "send_contract_identity_sha256"),
        "source_identity_sha256": _text(
            summary,
        ...
        "consistency_error": _text(
            summary,
            "send_contract_identity_consistency_error",
        ),
        "gate_passed": _to_bool(
            summary.get("send_contract_identity_gate_passed", False)
        ),
    }


def _contract_identity_manifest_fields(summary: pd.Series) -> dict[str, Any]:
    return {
        "send_contract_identity_active": _to_bool(
            summary.get("send_contract_identity_active", False)
        ),
        "send_contract_identity_gate_passed": _to_bool(
            summary.get("send_contract_identity_gate_passed", False)
        ),
        "send_contract_identity_sha256": _text(
            summary,
            "send_contract_identity_sha256",
        ),
        "send_contract_identity_source_sha256": _text(
            summary,
            "send_contract_identity_source_sha256",
        ),
        "send_contract_identity_source_manifest_sha256": _text(
            summary,
            "send_contract_identity_source_manifest_sha256",
        ),
    }
...
def _config(
    ...
    return {
        ...
        "expected_ack_templates": int(summary["expected_ack_templates"]),
        ...
        "contract_identity": _contract_identity_config(summary),
        "strategy_portfolio": {
        ...
        SEND_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_55_COMPARISON_KEY: (
            _broker_vendor_send_current_latest_extended_complete_final_lineage_55_config(
                summary
            )
        ),
        SEND_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_63_COMPARISON_KEY: (
            _broker_vendor_send_reconciled_current_latest_extended_complete_final_lineage_63_config(
                summary
            )
        ),
        SEND_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_71_COMPARISON_KEY: (
            _broker_vendor_send_verified_reconciled_current_latest_extended_complete_final_lineage_71_config(
                summary
            )
        ),
        SEND_CONFIRMED_VERIFIED_RECONCILED_CURRENT_LATEST_EXTENDED_COMPLETE_FINAL_LINEAGE_79_COMPARISON_KEY: (
            _broker_vendor_send_confirmed_verified_reconciled_current_latest_extended_complete_final_lineage_79_config(
                summary
            )
        ),
...
def _runbook_markdown(summary_row: pd.Series, action_queue: pd.DataFrame) -> str:
    ...
    lines = [
        ...
        (
            "- Contract identity active: "
            f"{'yes' if _to_bool(summary_row.get('send_contract_identity_active')) else 'no'}"
        ),
        (
            "- Contract identity source reconstructed: "
            f"{'yes' if _to_bool(summary_row.get('send_contract_identity_source_artifacts_consistent')) else 'no'}"
        ),
        (
            "- Contract identity requests / expected acknowledgements: "
            f"{_int_value(summary_row.get('send_contract_identity_request_orders'))} / "
            f"{_int_value(summary_row.get('send_contract_identity_expected_ack_orders'))}"
        ),
        (
            "- Contract identity gate passed: "
            f"{'yes' if _to_bool(summary_row.get('send_contract_identity_gate_passed')) else 'no'}"
        ),
        ...
        (
            "- Dispatch broker route contract identity active: "
            f"{'yes' if _to_bool(summary_row.get('broker_dispatch_route_enable_route_contract_identity_active')) else 'no'}"
        ),
        (
            "- Dispatch carried broker route contract identity: "
            f"{_code(summary_row.get('broker_dispatch_route_enable_cutover_runtime_telemetry_broker_readiness_route_contract_identity_sha256'))}"
        ),
        (
            "- Current route-enable broker route contract identity: "
            f"{_code(summary_row.get('broker_dispatch_current_route_enable_route_contract_identity_sha256'))}"
        ),
        (
            "- Dispatch broker route contract identity matches current: "
            f"{'yes' if _to_bool(summary_row.get('broker_dispatch_route_enable_route_contract_identity_matches_current')) else 'no'}"
        ),
        (
            "- Dispatch broker route-enable route contract identity active: "
            f"{'yes' if _to_bool(summary_row.get('broker_dispatch_route_enable_route_enable_route_contract_identity_active')) else 'no'}"
        ),
        (
            "- Dispatch carried broker route-enable route contract identity: "
            f"{_code(summary_row.get('broker_dispatch_route_enable_cutover_runtime_telemetry_broker_readiness_route_enable_route_contract_identity_sha256'))}"
        ),
        (
            "- Current route-enable broker route-enable route contract identity: "
            f"{_code(summary_row.get('broker_dispatch_current_route_enable_route_enable_route_contract_identity_sha256'))}"
        ),
        (
        ...
        (
            ...
            f"{'yes' if _to_bool(summary_row.get('broker_dispatch_route_enable_cutover_broker_readiness_matches_current')) else 'no'}"
        ),
        (
            "- Current broker-readiness manifest: "
            f"{_code(summary_row.get('broker_dispatch_route_enable_cutover_current_broker_readiness_manifest_sha256'))}"
        ),
...
def _load_upload_contract_identity(
    ...
    identity_path = _manifest_input_path(
        dispatch_manifest_path,
        "upload_contract_identity",
    )
    config_path = _manifest_input_path(dispatch_manifest_path, "upload_config")
    manifest_path = _manifest_input_path(
        dispatch_manifest_path,
        "upload_manifest",
    )
    active = bool(identity_path or config_path or manifest_path)
    proof_required = active
    errors: list[str] = []
    ...
    if identity_path is not None:
        ...
        errors.append("contract_identity_manifest_input_missing")
    ...
    if config_path is not None:
        try:
            ...
            errors.append(f"upload_config_invalid:{str(exc).strip()}")
    elif active:
        errors.append("upload_config_manifest_input_missing")

    integrity = None
    if identity_path is not None:
        try:
            integrity = verify_order_upload_pack_evidence(identity_path)
        except (OSError, TypeError, ValueError, pd.errors.ParserError) as exc:
            errors.append(
                f"upload_pack_evidence_invalid:{str(exc).strip()}"
            )
    if manifest_path is None and active:
        errors.append("upload_manifest_manifest_input_missing")
    elif (
        integrity is not None
        and manifest_path is not None
        and integrity.manifest_path.resolve() != manifest_path.resolve()
    ):
        errors.append("upload_manifest_path_mismatch")
    if integrity is not None and integrity.consistency_error:
        errors.append(integrity.consistency_error)
    ...
    if identity_path is not None:
        try:
            ...
            errors.append("contract_identity_sha256_unavailable")
    return identity, {
        "active": active,
        "proof_required": proof_required,
        "adapter": _object_text(upload_config.get("adapter", "")).strip(),
        "identity_path": identity_path or "",
        ...
        "passed": bool(integrity is not None and integrity.passed),
        "consistency_error": ";".join(value for value in errors if value),
    }


def _read_dispatch_orders(path: str | Path) -> pd.DataFrame:
    file_path = Path(path)
    if not file_path.exists():
        raise FileNotFoundError(
            f"required broker dispatch send input not found: {file_path}"
        )
    frame = pd.read_csv(file_path, dtype=str, keep_default_na=False)
    if frame.empty:
        raise ValueError(
            "required broker dispatch send input is empty: broker_dispatch_orders"
        )
    return frame
