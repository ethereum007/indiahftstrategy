...
def _checks(row: pd.Series) -> pd.DataFrame:
    ...
    if _to_bool(row.get("scaleup_manifest_required", False)):
        ...
        if broker_readiness_active:
            ...
            route_enable_identity_active = _to_bool(
                row.get(
                    (
                        "scaleup_broker_readiness_route_enable_"
                        "route_contract_identity_active"
            ...
            if route_enable_identity_active:
                ...
                current_route_enable_identity_sha = str(
                    row.get(
                        (
                ...
                route_enable_identity_matches = _to_bool(
                    row.get(
                        (
                            "scaleup_broker_readiness_route_enable_"
                            "route_contract_identity_matches_current"
            ...
            if route_enable_route_enable_identity_active:
                route_enable_route_enable_identity_sha = str(
                    row.get(
                        (
                            "scaleup_broker_readiness_route_enable_route_enable_"
                            "route_contract_identity_sha256"
                ...
                current_route_enable_route_enable_identity_sha = str(
                    row.get(
                        (
                            "scaleup_broker_readiness_current_"
                ...
                route_enable_route_enable_identity_matches = _to_bool(
                    row.get(
                        (
                            "scaleup_broker_readiness_route_enable_route_enable_"
                            "route_contract_identity_matches_current"
