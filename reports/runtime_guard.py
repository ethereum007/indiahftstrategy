...
from reports.scaleup_runtime_provenance import (
    ...
    BROKER_READINESS_ROUTE_ENABLE_ROUTE_ENABLE_ROUTE_ENABLE_ROUTE_CONTRACT_IDENTITY_LINEAGE_FIELDS,
    ...
    if _to_bool(row.get("scaleup_manifest_required", False)):
        ...
        if broker_readiness_active:
            ...
            if route_enable_route_enable_identity_active:
                route_enable_route_enable_identity_sha = _clean(
                    row.get(
                        (
                            "scaleup_broker_readiness_"
                            "route_enable_route_enable_"
                ...
                current_route_enable_route_enable_identity_sha = _clean(
                    row.get(
                        (
                            "scaleup_broker_readiness_current_"
                            "route_enable_route_enable_"
                ...
                scaleup_route_enable_route_enable_identity_matches = _to_bool(
                    row.get(
                        (
                            "scaleup_broker_readiness_"
                            "route_enable_route_enable_"
                ...
                telemetry_route_enable_route_enable_identity_matches = _to_bool(
                    row.get(
                        (
                            "runtime_telemetry_broker_readiness_"
                            "route_enable_route_enable_"
                ...
                route_enable_route_enable_sha_matches = bool(
                    route_enable_route_enable_identity_sha
                    and current_route_enable_route_enable_identity_sha
                    and (
                        route_enable_route_enable_identity_sha
                        == current_route_enable_route_enable_identity_sha
                    )
                )
                checks.extend(
                    [
                        _check(
                            ...
                            "present",
                            True,
                            bool(route_enable_route_enable_identity_sha),
                            (
                                "scale-up broker-readiness route-enable "
                        ...
                        _check(
                            ...
                            route_enable_route_enable_sha_matches,
                            "is",
                            True,
                            route_enable_route_enable_sha_matches,
                            (
                                "scale-up broker-readiness route-enable "
                                "route-enable route contract identity differs "
                        ...
                        _check(
                            ...
                            scaleup_route_enable_route_enable_identity_matches,
                            "is",
                            True,
                            scaleup_route_enable_route_enable_identity_matches,
                            (
                        ...
                        _check(
                            ...
                            telemetry_route_enable_route_enable_identity_matches,
                            "is",
                            True,
                            telemetry_route_enable_route_enable_identity_matches,
                            (
                                "runtime telemetry route-enable route-enable "
                                "route contract identity differs from the "
                                "current scale-up"
                            ),
                        ),
            ...
            if route_enable_route_enable_route_enable_identity_active:
                route_enable_route_enable_route_enable_identity_sha = _clean(
                    row.get(
                        (
                            "scaleup_broker_readiness_route_enable_"
                            "route_enable_route_enable_"
                ...
                scaleup_route_enable_route_enable_route_enable_identity_matches = (
                    _to_bool(
                        row.get(
                            (
                                "scaleup_broker_readiness_route_enable_"
                ...
                telemetry_route_enable_route_enable_route_enable_identity_matches = (
                    _to_bool(
                        row.get(
                            (
                                "runtime_telemetry_broker_readiness_"
...
def _runtime_lineage_fields(
    ...
    current_route_enable_route_enable_identity_active = _to_bool(
        provenance.get(
            (
    ...
    telemetry_route_enable_route_enable_identity_active = _bool_value(
        latest,
        (
            "scaleup_broker_readiness_route_enable_route_enable_"
            "route_contract_identity_active"
    ...
    broker_readiness_active = bool(
        ...
        or telemetry_route_enable_route_enable_identity_active
    )
    current_route_enable_route_enable_identity_sha = _clean(
        provenance.get(
            (
    ...
    telemetry_route_enable_route_enable_identity_sha = _clean(
        _value(
            latest,
            (
                "scaleup_broker_readiness_route_enable_route_enable_"
    ...
    current_route_enable_route_enable_identity_source_sha = _clean(
        provenance.get(
            (
    ...
    telemetry_route_enable_route_enable_identity_source_sha = _clean(
        _value(
            latest,
            (
    ...
    current_route_enable_route_enable_identity_source_match = _to_bool(
        provenance.get(
            (
                "broker_readiness_route_enable_route_enable_"
                "route_contract_identity_matches_current"
    ...
    telemetry_route_enable_route_enable_identity_source_match = _bool_value(
        latest,
        (
            "scaleup_broker_readiness_route_enable_route_enable_"
            "route_contract_identity_matches_current"
    ...
    route_enable_route_enable_identity_fields_match = all(
        _broker_contract_identity_value_matches(
            _value(latest, f"scaleup_{report_field}", None),
            provenance.get(report_field),
            report_field,
    ...
    route_enable_route_enable_identity_matches = bool(
        route_enable_route_enable_identity_fields_match
        and (
            (
                not current_route_enable_route_enable_identity_active
                and not telemetry_route_enable_route_enable_identity_active
            )
            or (
                current_route_enable_route_enable_identity_active
                and telemetry_route_enable_route_enable_identity_active
                and current_route_enable_route_enable_identity_sha
                and (
                    telemetry_route_enable_route_enable_identity_sha
                    == current_route_enable_route_enable_identity_sha
                )
                and current_route_enable_route_enable_identity_source_sha
                and (
                    telemetry_route_enable_route_enable_identity_source_sha
                    == current_route_enable_route_enable_identity_source_sha
                )
                and (
                    current_route_enable_route_enable_identity_sha
                    == current_route_enable_route_enable_identity_source_sha
                )
                and current_route_enable_route_enable_identity_source_match
                and telemetry_route_enable_route_enable_identity_source_match
            )
        )
    )
    current_route_enable_route_enable_route_enable_identity_active = _to_bool(
        provenance.get(
            (
    ...
    telemetry_route_enable_route_enable_route_enable_identity_active = (
        _bool_value(
            latest,
            (
                "scaleup_broker_readiness_route_enable_route_enable_"
    ...
    broker_readiness_active = bool(
        ...
        or telemetry_route_enable_route_enable_route_enable_identity_active
    )
    current_route_enable_route_enable_route_enable_identity_sha = _clean(
        provenance.get(
            (
                "broker_readiness_route_enable_route_enable_route_enable_"
                "route_contract_identity_sha256"
    ...
    telemetry_route_enable_route_enable_route_enable_identity_sha = _clean(
        _value(
            latest,
            (
                "scaleup_broker_readiness_route_enable_route_enable_"
    ...
    current_route_enable_route_enable_route_enable_identity_source_sha = (
        _clean(
            provenance.get(
                (
                    "broker_readiness_current_route_enable_route_enable_"
    ...
    telemetry_route_enable_route_enable_route_enable_identity_source_sha = (
        _clean(
            _value(
                latest,
                (
    ...
    current_route_enable_route_enable_route_enable_identity_source_match = (
        _to_bool(
            provenance.get(
                (
                    "broker_readiness_route_enable_route_enable_route_enable_"
    ...
    telemetry_route_enable_route_enable_route_enable_identity_source_match = (
        _bool_value(
            latest,
            (
                "scaleup_broker_readiness_route_enable_route_enable_"
    ...
    route_enable_route_enable_route_enable_identity_fields_match = all(
        _broker_contract_identity_value_matches(
            _value(latest, f"scaleup_{report_field}", None),
            provenance.get(report_field),
            report_field,
    ...
    route_enable_route_enable_route_enable_identity_matches = bool(
        route_enable_route_enable_route_enable_identity_fields_match
        and (
            (
                not current_route_enable_route_enable_route_enable_identity_active
                and not telemetry_route_enable_route_enable_route_enable_identity_active
            )
            or (
                current_route_enable_route_enable_route_enable_identity_active
                and telemetry_route_enable_route_enable_route_enable_identity_active
                and current_route_enable_route_enable_route_enable_identity_sha
                and (
                    telemetry_route_enable_route_enable_route_enable_identity_sha
                    == current_route_enable_route_enable_route_enable_identity_sha
                )
                and (
                    current_route_enable_route_enable_route_enable_identity_source_sha
    ...
    broker_readiness_matches = bool(
        ...
        or (
            ...
            and route_enable_route_enable_identity_matches
            and route_enable_route_enable_route_enable_identity_matches
        )
    )
    ...
    return {
        ...
        (
            "runtime_telemetry_broker_readiness_route_enable_route_enable_"
            "route_contract_identity_active"
        ): telemetry_route_enable_route_enable_identity_active,
        (
            "runtime_telemetry_broker_readiness_route_enable_route_enable_"
            "route_contract_identity_sha256"
        ): telemetry_route_enable_route_enable_identity_sha,
        ...
        (
            "runtime_telemetry_broker_readiness_route_enable_route_enable_"
            "route_contract_identity_matches_current"
        ): route_enable_route_enable_identity_matches,
        (
            "runtime_telemetry_broker_readiness_route_enable_route_enable_"
            "route_enable_route_contract_identity_active"
        ): telemetry_route_enable_route_enable_route_enable_identity_active,
